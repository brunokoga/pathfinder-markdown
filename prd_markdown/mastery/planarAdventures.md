...
**Heavy Gravity** : The gravity on a plane with this trait is much more intense than on the Material Plane. As a result, [Acrobatics](../skills/acrobatics.html#_acrobatics), [Climb](../skills/climb.html#_climb), [Ride](../skills/ride.html#_ride), and [Swim](../skills/swim.html#_swim) checks incur a –2 circumstance penalty, as do all attack rolls. All item weights are effectively doubled, which might affect a character's speed. Weapon ranges are halved. A character's Strength and Dexterity scores are not affected. Characters that fall on a heavy gravity plane take 1d10 points of damage for each 10 feet fallen, to a maximum of 20d10 points of damage.

**Light Gravity** : The gravity on a plane with this trait is less intense than on the Material Plane. As a result, creatures find that they can lift more. Characters on a plane with the light gravity trait take a +2 circumstance bonus on attack rolls and on [Acrobatics](../skills/acrobatics.html#_acrobatics) and [Ride](../skills/ride.html#_ride) checks. All items weigh half as much, and weapon ranges double. Strength and Dexterity don't change as a result of light gravity, but what you can do with such scores does change. These advantages apply to travelers from other planes as well as natives. Falling characters on a light gravity plane take 1d4 points of damage for each 10 feet fallen (maximum 20d4).
...
**Objective Directional Gravity** : The strength of gravity on a plane with this trait is the same as on the Material Plane, but the direction is not the traditional âdownâ toward the ground. It may be down toward any solid object, at an angle to the surface of the plane itself, or even upward. In addition, the direction of âdownâ may vary from place to place within the plane.

**Subjective Directional Gravity** : The strength of gravity on a plane with this trait is the same as on the Material Plane, but each individual chooses the direction of gravity's pull. Such a plane has no gravity for unattended objects and nonsentient creatures. This sort of environment can be very disorienting to the newcomer, but it is common on âweightlessâ planes.

Characters on a plane with subjective directional gravity can move normally along a solid surface by imagining âdownâ near their feet. If suspended in midair, a character âfliesâ by merely choosing a âdownâ direction and âfallingâ that way. Under such a procedure, an individual âfallsâ 150 feet in the first round and 300 feet in each succeeding round. Movement is straight-line only. In order to stop, one has to slow one's movement by changing the designated âdownâ direction (again, moving 150 feet in the new direction in the first round and 300 feet per round thereafter).
...
**Dead Magic** : These planes have no magic at all. A plane with the dead magic trait functions in all respects like an _ [antimagic field](../spells/antimagicField.html#_antimagic-field)_ spell. Divination spells cannot detect subjects within a dead magic plane, nor can a spellcaster use _ [teleport](../spells/teleport.html#_teleport)_ or another spell to move in or out. The only exception to the âno magicâ rule is permanent planar portals, which still function normally.
...
| 36–39 | The spell does not function. Instead, everyone (friend or foe) within 30 feet of the caster receives the effect of a _ [heal](../spells/heal.html#_heal)_ spell. |
| 40–43 | The spell does not function. Instead, a _ [deeper darkness](../spells/deeperDarkness.html#_deeper-darkness)_ effect and a _ [silence](../spells/silence.html#_silence)_ effect cover a 30-foot radius around the caster for 2d4 rounds. |
| 44–47 | The spell does not function. Instead, a _ [reverse gravity](../spells/reverseGravity.html#_reverse-gravity)_ effect covers a 30-foot radius around the caster for 1 round. |
| 48–51 | The spell functions, but shimmering colors swirl around the caster for 1d4 rounds. Treat this as a _ [glitterdust](../spells/glitterdust.html#_glitterdust)_ effect with a save DC of 10 + the level of the spell that generated this result. |
...
| 99–100 | The spell functions strongly. Saving throws against the spell incur a –2 penalty. The spell has the maximum possible effect, as if it were cast with the [Maximize Spell](../feats.html#_maximize-spell) feat. If the spell is already maximized with the feat, there is no further effect. |
...
- **Magically Morphic** : Parts of the Shadow Plane continually flow onto other planes. As a result, creating a precise map of the plane is next to impossible, despite the presence of landmarks. In addition, certain spells, such as _ [shadow conjuration](../spells/shadowConjuration.html#_shadow-conjuration)_ and _ [shadow evocation](../spells/shadowEvocation.html#_shadow-evocation)_, modify the base material of the Shadow Plane. The utility and power of these spells within the Shadow Plane make them particularly useful for explorers and natives alike. 
- **Mildly Neutral-Aligned**
- **Enhanced Magic** : Spells with the shadow descriptor are enhanced on the Shadow Plane. Furthermore, specific spells become more powerful on the Shadow Plane. _ [Shadow conjuration](../spells/shadowConjuration.html#_shadow-conjuration)_ and _ [shadow evocation](../spells/shadowEvocation.html#_shadow-evocation)_ spells are 30% as powerful as the conjurations and evocations they mimic (as opposed to 20%). _ [Greater](../spells/shadowConjuration.html#_shadow-conjuration-greater) [shadow](../magicItems/armor.html#_armor-shadow) conjuration_ and _ [greater](../spells/shadowEvocation.html#_shadow-evocation-greater) [shadow](../magicItems/armor.html#_armor-shadow) evocation_ are 70% as powerful (not 60%), and a _ [shades](../spells/shades.html#_shades)_ spell conjures at 90% of the power of the original (not 80%). Despite the dark nature of the Shadow Plane, spells that produce, use, or manipulate darkness are unaffected by the plane.
...
- **Subjective Directional Gravity** : Inhabitants of the plane determine their own âdownâ direction. Objects not under the motive force of others do not move.
- **Air-Dominant**
...
- **Mildly Neutral-Aligned**
- **Enhanced Magic** : All spells and spell-like abilities used within the Astral Plane may be employed as if they were improved by the [Quicken Spell](../feats.html#_quicken-spell) or [Quicken Spell-Like Ability](../monsters/monsterFeats.html#_quicken-spell-like-ability) feats. Already quickened spells and spell-like abilities are unaffected, as are spells from magic items. Spells so quickened are still prepared and cast at their unmodified level. As with the [Quicken Spell](../feats.html#_quicken-spell) feat, only one quickened spell or spell-like ability can be cast per round.
