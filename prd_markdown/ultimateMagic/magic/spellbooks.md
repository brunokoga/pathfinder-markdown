...
1st—_ [burning hands](/pathfinderRPG/prd/spells/burningHands.html#_burning-hands)_, _ [detect undead](/pathfinderRPG/prd/spells/detectUndead.html#_detect-undead)_, _ [expeditious retreat](/pathfinderRPG/prd/spells/expeditiousRetreat.html#_expeditious-retreat)_, _ [magic missile](/pathfinderRPG/prd/spells/magicMissile.html#_magic-missile)_, _ [protection from evil](/pathfinderRPG/prd/spells/protectionFromEvil.html#_protection-from-evil)_S, _ [ray of enfeeblement](/pathfinderRPG/prd/spells/rayOfEnfeeblement.html#_ray-of-enfeeblement)_, _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_S
...
1st—_ [comprehend languages](/pathfinderRPG/prd/spells/comprehendLanguages.html#_comprehend-languages)_S, _ [detect secret doors](/pathfinderRPG/prd/spells/detectSecretDoors.html#_detect-secret-doors)_S, _ [detect undead](/pathfinderRPG/prd/spells/detectUndead.html#_detect-undead)_S, _ [identify](/pathfinderRPG/prd/spells/identify.html#_identify)_S, _ [protection from evil](/pathfinderRPG/prd/spells/protectionFromEvil.html#_protection-from-evil)_, _ [protection from law](/pathfinderRPG/prd/spells/protectionFromLaw.html#_protection-from-law)_, _ [summon monster I](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-i)_, _ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike)_S
...
2nd—_ [glide](/pathfinderRPG/prd/advanced/spells/glide.html#_glide-)_S, , _ [knock](/pathfinderRPG/prd/spells/knock.html#_knock)_S, _ [levitate](/pathfinderRPG/prd/spells/levitate.html#_levitate)_S, _ [rope trick](/pathfinderRPG/prd/spells/ropeTrick.html#_rope-trick)_S

1st—_ [ant haul](/pathfinderRPG/prd/advanced/spells/antHaul.html#_ant-haul-)_S, , _ [enlarge person](/pathfinderRPG/prd/spells/enlargePerson.html#_enlarge-person)_S, _ [erase](/pathfinderRPG/prd/spells/erase.html#_erase)_S, _ [expeditious retreat](/pathfinderRPG/prd/spells/expeditiousRetreat.html#_expeditious-retreat)_S, _ [gravity bow](/pathfinderRPG/prd/advanced/spells/gravityBow.html#_gravity-bow-)_S, , _ [hold portal](/pathfinderRPG/prd/spells/holdPortal.html#_hold-portal)_, _ [jump](/pathfinderRPG/prd/spells/jump.html#_jump)_S, _ [magic weapon](/pathfinderRPG/prd/spells/magicWeapon.html#_magic-weapon)_S, _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_
...
3rd—_ [fireball](/pathfinderRPG/prd/spells/fireball.html#_fireball)_S, _ [lightning bolt](/pathfinderRPG/prd/spells/lightningBolt.html#_lightning-bolt)_S

2nd—_ [acid arrow](/pathfinderRPG/prd/spells/acidArrow.html#_acid-arrow)_, _ [darkness](/pathfinderRPG/prd/spells/darkness.html#_darkness)_S, _ [ghoul touch](/pathfinderRPG/prd/spells/ghoulTouch.html#_ghoul-touch)_, _ [gust of wind](/pathfinderRPG/prd/spells/gustOfWind.html#_gust-of-wind)_S

1st—_ [burning hands](/pathfinderRPG/prd/spells/burningHands.html#_burning-hands)_S, _ [color spray](/pathfinderRPG/prd/spells/colorSpray.html#_color-spray)_, _ [corrosive touch](/pathfinderRPG/prd/ultimateMagic/spells/corrosiveTouch.html#corrosive-touch)_S, , _ [hydraulic push](/pathfinderRPG/prd/advanced/spells/hydraulicPush.html#_hydraulic-push-)_S, , _ [hypnotism](/pathfinderRPG/prd/spells/hypnotism.html#_hypnotism)_, _ [magic missile](/pathfinderRPG/prd/spells/magicMissile.html#_magic-missile)_S, _ [ray of enfeeblement](/pathfinderRPG/prd/spells/rayOfEnfeeblement.html#_ray-of-enfeeblement)_, _ [shocking grasp](/pathfinderRPG/prd/spells/shockingGrasp.html#_shocking-grasp)_S
...
3rd—_ [blood biography](/pathfinderRPG/prd/advanced/spells/bloodBiography.html#_blood-biography-)_, _ [ray of exhaustion](/pathfinderRPG/prd/spells/rayOfExhaustion.html#_ray-of-exhaustion)_S, _ [vampiric touch](/pathfinderRPG/prd/spells/vampiricTouch.html#_vampiric-touch)_S, _vitriol_

2nd—_ [command undead](/pathfinderRPG/prd/spells/commandUndead.html#_command-undead)_S, _ [create treasure map](/pathfinderRPG/prd/advanced/spells/createTreasureMap.html#_create-treasure-map-)_, _ [ghoul touch](/pathfinderRPG/prd/spells/ghoulTouch.html#_ghoul-touch)_S, _ [spectral hand](/pathfinderRPG/prd/spells/spectralHand.html#_spectral-hand)_S, _ [stone call](/pathfinderRPG/prd/advanced/spells/stoneCall.html#_stone-call)_, _ [web](/pathfinderRPG/prd/spells/web.html#_web)_

1st—_ [burning hands](/pathfinderRPG/prd/spells/burningHands.html#_burning-hands)_, _ [chill touch](/pathfinderRPG/prd/spells/chillTouch.html#_chill-touch)_S, _ [disguise self](/pathfinderRPG/prd/spells/disguiseSelf.html#_disguise-self)_, _ [mage armor](/pathfinderRPG/prd/spells/mageArmor.html#_mage-armor)_, _ [protection from good](/pathfinderRPG/prd/spells/protectionFromGood.html#_protection-from-good)_, _ [ray of enfeeblement](/pathfinderRPG/prd/spells/rayOfEnfeeblement.html#_ray-of-enfeeblement)_S, _ [sculpt corpse](/pathfinderRPG/prd/advanced/spells/sculptCorpse.html#_sculpt-corpse-)_S, , _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_, _ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike)_, _ [ventriloquism](/pathfinderRPG/prd/spells/ventriloquism.html#_ventriloquism)_
...
4th—_ [phantasmal killer](/pathfinderRPG/prd/spells/phantasmalKiller.html#_phantasmal-killer)_S, _ [wandering star motes](/pathfinderRPG/prd/advanced/spells/wanderingStarMotes.html#_wandering-star-motes)_S,

3rd—_ [illusory script](/pathfinderRPG/prd/spells/illusoryScript.html#_illusory-script)_S, _ [invisibility sphere](/pathfinderRPG/prd/spells/invisibilitySphere.html#_invisibility-sphere)_S, _madness_S, , _ [major image](/pathfinderRPG/prd/spells/majorImage.html#_major-image)_S

2nd—_ [magic mouth](/pathfinderRPG/prd/spells/magicMouth.html#_magic-mouth)_S, _ [misdirection](/pathfinderRPG/prd/spells/misdirection.html#_misdirection)_S, _ [phantom trap](/pathfinderRPG/prd/spells/phantomTrap.html#_phantom-trap)_S, _ [scare](/pathfinderRPG/prd/spells/scare.html#_scare)_OP

1st—_ [alarm](/pathfinderRPG/prd/spells/alarm.html#_alarm)_, _ [animate rope](/pathfinderRPG/prd/spells/animateRope.html#_animate-rope)_, _ [color spray](/pathfinderRPG/prd/spells/colorSpray.html#_color-spray)_S, _ [comprehend languages](/pathfinderRPG/prd/spells/comprehendLanguages.html#_comprehend-languages)_, _ [disguise self](/pathfinderRPG/prd/spells/disguiseSelf.html#_disguise-self)_S, _ [hypnotism](/pathfinderRPG/prd/spells/hypnotism.html#_hypnotism)_, _ [magic aura](/pathfinderRPG/prd/spells/magicAura.html#_magic-aura)_S, _ [magic weapon](/pathfinderRPG/prd/spells/magicWeapon.html#_magic-weapon)_, _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_, _ [sleep](/pathfinderRPG/prd/spells/sleep.html#_sleep)_
...
4th—_ [beast shape II](/pathfinderRPG/prd/spells/beastShape.html#_beast-shape-ii)_S, _ [calcific touch](/pathfinderRPG/prd/advanced/spells/calcificTouch.html#_calcific-touch)_S, , _ [confusion](/pathfinderRPG/prd/spells/confusion.html#_confusion)_, _ [dimension door](/pathfinderRPG/prd/spells/dimensionDoor.html#_dimension-door)_, _ [stone shape](/pathfinderRPG/prd/spells/stoneShape.html#_stone-shape)_S

3rd—_ [arcane sight](/pathfinderRPG/prd/spells/arcaneSight.html#_arcane-sight)_, _ [dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic)_, _ [explosive runes](/pathfinderRPG/prd/spells/explosiveRunes.html#_explosive-runes)_, _ [lightning bolt](/pathfinderRPG/prd/spells/lightningBolt.html#_lightning-bolt)_, _ [greater magic weapon](/pathfinderRPG/prd/spells/magicWeapon.html#_magic-weapon-greater)_S, _ [slow](/pathfinderRPG/prd/spells/slow.html#_slow)_S

2nd—_ [alter self](/pathfinderRPG/prd/spells/alterSelf.html#_alter-self)_S, _ [flaming sphere](/pathfinderRPG/prd/spells/flamingSphere.html#_flaming-sphere)_, _ [knock](/pathfinderRPG/prd/spells/knock.html#_knock)_S, _ [pyrotechnics](/pathfinderRPG/prd/spells/pyrotechnics.html#_pyrotechnics)_S, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_, _ [see invisibility](/pathfinderRPG/prd/spells/seeInvisibility.html#_see-invisibility)_, _ [whispering wind](/pathfinderRPG/prd/spells/whisperingWind.html#_whispering-wind)_S

1st—_ [animate rope](/pathfinderRPG/prd/spells/animateRope.html#_animate-rope)_S, _ [charm person](/pathfinderRPG/prd/spells/charmPerson.html#_charm-person)_, _ [color spray](/pathfinderRPG/prd/spells/colorSpray.html#_color-spray)_OP, _ [erase](/pathfinderRPG/prd/spells/erase.html#_erase)_S, _ [floating disk](/pathfinderRPG/prd/spells/floatingDisk.html#_floating-disk)_, _hush_, _ [mage armor](/pathfinderRPG/prd/spells/mageArmor.html#_mage-armor)_, _ [magic missile](/pathfinderRPG/prd/spells/magicMissile.html#_magic-missile)_, _ [protection from chaos](/pathfinderRPG/prd/spells/protectionFromChaos.html#_protection-from-chaos)_, _ [unseen servant](/pathfinderRPG/prd/spells/unseenServant.html#_unseen-servant)_
...
5th—_ [contact other plane](/pathfinderRPG/prd/spells/contactOtherPlane.html#_contact-other-plane)_S, _ [major creation](/pathfinderRPG/prd/spells/majorCreation.html#_major-creation)_, _ [telepathic bond](/pathfinderRPG/prd/spells/telepathicBond.html#_telepathic-bond)_S,

4th—_ [detect scrying](/pathfinderRPG/prd/spells/detectScrying.html#_detect-scrying)_S, _ [locate creature](/pathfinderRPG/prd/spells/locateCreature.html#_locate-creature)_S, _ [remove curse](/pathfinderRPG/prd/spells/removeCurse.html#_remove-curse)_, _ [scrying](/pathfinderRPG/prd/spells/scrying.html#_scrying)_S

3rd—_ [arcane sight](/pathfinderRPG/prd/spells/arcaneSight.html#_arcane-sight)_S, _ [clairaudience/clairvoyance](/pathfinderRPG/prd/spells/clairaudienceClairvoyance.html#_clairaudience-clairvoyance)_S, _ [secret page](/pathfinderRPG/prd/spells/secretPage.html#_secret-page)_OP, _ [tongues](/pathfinderRPG/prd/spells/tongues.html#_tongues)_S

2nd—_ [detect thoughts](/pathfinderRPG/prd/spells/detectThoughts.html#_detect-thoughts)_S, _ [flaming sphere](/pathfinderRPG/prd/spells/flamingSphere.html#_flaming-sphere)_, _ [locate object](/pathfinderRPG/prd/spells/locateObject.html#_locate-object)_S, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_, _ [see invisibility](/pathfinderRPG/prd/spells/seeInvisibility.html#_see-invisibility)_S, _ [summon monster II](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-ii)_

1st—_ [cause fear](/pathfinderRPG/prd/spells/causeFear.html#_cause-fear)_, _ [comprehend languages](/pathfinderRPG/prd/spells/comprehendLanguages.html#_comprehend-languages)_S, _ [detect secret doors](/pathfinderRPG/prd/spells/detectSecretDoors.html#_detect-secret-doors)_S, _ [detect undead](/pathfinderRPG/prd/spells/detectUndead.html#_detect-undead)_S, _ [disguise self](/pathfinderRPG/prd/spells/disguiseSelf.html#_disguise-self)_OP, _ [identify](/pathfinderRPG/prd/spells/identify.html#_identify)_S, _ [protection from evil](/pathfinderRPG/prd/spells/protectionFromEvil.html#_protection-from-evil)_, _ [protection from law](/pathfinderRPG/prd/spells/protectionFromLaw.html#_protection-from-law)_, _ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike)_S
...
6th—_ [contingency](/pathfinderRPG/prd/spells/contingency.html#_contingency)_S, _ [freezing sphere](/pathfinderRPG/prd/spells/freezingSphere.html#_freezing-sphere)_S, _ [repulsion](/pathfinderRPG/prd/spells/repulsion.html#_repulsion)_

5th—_ [cone of cold](/pathfinderRPG/prd/spells/coneOfCold.html#_cone-of-cold)_S, _ [mage's private sanctum](/pathfinderRPG/prd/spells/mageSPrivateSanctum.html#_mage-s-private-sanctum)_, _ [permanency](/pathfinderRPG/prd/spells/permanency.html#_permanency)_, _ [teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport)_, _ [wall of force](/pathfinderRPG/prd/spells/wallOfForce.html#_wall-of-force)_S

4th—_ [ice storm](/pathfinderRPG/prd/spells/iceStorm.html#_ice-storm)_S, _ [shout](/pathfinderRPG/prd/spells/shout.html#_shout)_S, _ [stoneskin](/pathfinderRPG/prd/spells/stoneskin.html#_stoneskin)_, _ [symbol of revelation](../spells/symbolOfRevelation.html#_symbol-of-revelation)_, _ [wall of ice](/pathfinderRPG/prd/spells/wallOfIce.html#_wall-of-ice)_S

3rd—_ [arcane sight](/pathfinderRPG/prd/spells/arcaneSight.html#_arcane-sight)_, _ [dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic)_, _ [elemental aura](/pathfinderRPG/prd/advanced/spells/elementalAura.html#_elemental-aura)_S, , _ [fire trap](/pathfinderRPG/prd/spells/fireTrap.html#_fire-trap)_, _ [heroism](/pathfinderRPG/prd/spells/heroism.html#_heroism)_, _ [lightning bolt](/pathfinderRPG/prd/spells/lightningBolt.html#_lightning-bolt)_S, _ [phantom steed](/pathfinderRPG/prd/spells/phantomSteed.html#_phantom-steed)_, _ [seek thoughts](/pathfinderRPG/prd/advanced/spells/seekThoughts.html#_seek-thoughts)_

2nd—_ [bull's strength](/pathfinderRPG/prd/spells/bullSStrength.html#_bull-s-strength)_, _ [false life](/pathfinderRPG/prd/spells/falseLife.html#_false-life)_OP, _ [glitterdust](/pathfinderRPG/prd/spells/glitterdust.html#_glitterdust)_, _ [hideous laughter](/pathfinderRPG/prd/spells/hideousLaughter.html#_hideous-laughter)_, _ [make whole](/pathfinderRPG/prd/spells/makeWhole.html#_make-whole)_, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_, _ [rope trick](/pathfinderRPG/prd/spells/ropeTrick.html#_rope-trick)_

1st—_ [detect secret doors](/pathfinderRPG/prd/spells/detectSecretDoors.html#_detect-secret-doors)_, _ [endure elements](/pathfinderRPG/prd/spells/endureElements.html#_endure-elements)_, _ [enlarge person](/pathfinderRPG/prd/spells/enlargePerson.html#_enlarge-person)_, _ [feather fall](/pathfinderRPG/prd/spells/featherFall.html#_feather-fall)_, _ [mage armor](/pathfinderRPG/prd/spells/mageArmor.html#_mage-armor)_, _ [magic missile](/pathfinderRPG/prd/spells/magicMissile.html#_magic-missile)_S, _ [obscuring mist](/pathfinderRPG/prd/spells/obscuringMist.html#_obscuring-mist)_, _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_, _ [shocking grasp](/pathfinderRPG/prd/spells/shockingGrasp.html#_shocking-grasp)_S
...
6th—_ [getaway](/pathfinderRPG/prd/advanced/spells/getaway.html#_getaway-)_S, , _ [planar binding](/pathfinderRPG/prd/spells/planarBinding.html#_planar-binding)_S, _ [summon monster VI](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-vi)_S, _ [wall of iron](/pathfinderRPG/prd/spells/wallOfIron.html#_wall-of-iron)_S

5th—_life bubble_S, , _ [contact other plane](/pathfinderRPG/prd/spells/contactOtherPlane.html#_contact-other-plane)_OP, _overland flight_S, , _ [teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport)_S

4th—_ [acid pit](/pathfinderRPG/prd/advanced/spells/acidPit.html#_acid-pit-)_S, , _ [black tentacles](/pathfinderRPG/prd/spells/blackTentacles.html#_black-tentacles)_S, _ [dimensional anchor](/pathfinderRPG/prd/spells/dimensionalAnchor.html#_dimensional)_, _ [lesser geas](/pathfinderRPG/prd/spells/geasQuest.html#_geas-lesser)_, _ [phantasmal killer](/pathfinderRPG/prd/spells/phantasmalKiller.html#_phantasmal-killer)_, _ [solid fog](/pathfinderRPG/prd/spells/solidFog.html#_solid-fog)_S

3rd—_ [gaseous form](/pathfinderRPG/prd/spells/gaseousForm.html#_gaseous-form)_, _ [greater magic weapon](/pathfinderRPG/prd/spells/magicWeapon.html#_magic-weapon-greater)_, _ [magic circle against evil](/pathfinderRPG/prd/spells/magicCircleAgainstEvil.html#_magic-circle-against-evil)_, _sepia snake sigil_S, _ [spiked pit](/pathfinderRPG/prd/advanced/spells/spikedPit.html#_spiked-pit)_S, , _ [stinking cloud](/pathfinderRPG/prd/spells/stinkingCloud.html#_stinking-cloud)_, _ [tiny hut](/pathfinderRPG/prd/spells/tinyHut.html#_tiny-hut)_

2nd—_ [arrow eruption](/pathfinderRPG/prd/advanced/spells/arrowEruption.html#_arrow-eruption-)_S, , _ [daze monster](/pathfinderRPG/prd/spells/dazeMonster.html#_daze-monster)_, _ [dust of twilight](/pathfinderRPG/prd/advanced/spells/dustOfTwilight.html#_dust-of-twilight)_S, , _fantastic reach_, _ [glitterdust](/pathfinderRPG/prd/spells/glitterdust.html#_glitterdust)_S, _metabolize_S, , _ [shatter](/pathfinderRPG/prd/spells/shatter.html#_shatter)_, _ [stone call](/pathfinderRPG/prd/advanced/spells/stoneCall.html#_stone-call)_S,

1st—_ [comprehend languages](/pathfinderRPG/prd/spells/comprehendLanguages.html#_comprehend-languages)_OP, _ [disguise self](/pathfinderRPG/prd/spells/disguiseSelf.html#_disguise-self)_, _ [jump](/pathfinderRPG/prd/spells/jump.html#_jump)_, _ [mage armor](/pathfinderRPG/prd/spells/mageArmor.html#_mage-armor)_S, _ [magic aura](/pathfinderRPG/prd/spells/magicAura.html#_magic-aura)_, _ [mount](/pathfinderRPG/prd/spells/mount.html#_mount)_S, _ [sleep](/pathfinderRPG/prd/spells/sleep.html#_sleep)_, _ [stumble gap](/pathfinderRPG/prd/advanced/spells/stumbleGap.html#_stumble-gap-)_S, , _ [unseen servant](/pathfinderRPG/prd/spells/unseenServant.html#_unseen-servant)_S
...
7th—_ [greater arcane sight](/pathfinderRPG/prd/spells/arcaneSight.html#_arcane-sight-greater)_S, _ [greater scrying](/pathfinderRPG/prd/spells/scrying.html#_scrying-greater)_S, _ [prismatic spray](/pathfinderRPG/prd/spells/prismaticSpray.html#_prismatic-spray)_

6th—_ [chain lightning](/pathfinderRPG/prd/spells/chainLightning.html#_chain-lightning)_, _ [contingency](/pathfinderRPG/prd/spells/contingency.html#_contingency)_, _ [eyebite](/pathfinderRPG/prd/spells/eyebite.html#_eyebite)_, _ [legend lore](/pathfinderRPG/prd/spells/legendLore.html#_legend-lore)_S, _ [true seeing](/pathfinderRPG/prd/spells/trueSeeing.html#_true-seeing)_S

5th—_ [dominate person](/pathfinderRPG/prd/spells/dominatePerson.html#_dominate-person)_, _ [fire snake](/pathfinderRPG/prd/advanced/spells/fireSnake.html#_fire-snake)_, _ [prying eyes](/pathfinderRPG/prd/spells/pryingEyes.html#_prying-eyes)_S, _ [teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport)_OP, _ [telepathic bond](/pathfinderRPG/prd/spells/telepathicBond.html#_telepathic-bond)_S

4th—_ [arcane eye](/pathfinderRPG/prd/spells/arcaneEye.html#_arcane-eye)_S, _ [confusion](/pathfinderRPG/prd/spells/confusion.html#_confusion)_, _ [detect scrying](/pathfinderRPG/prd/spells/detectScrying.html#_detect-scrying)_S, _ [fear](/pathfinderRPG/prd/spells/fear.html#_fear)_, _ [ice storm](/pathfinderRPG/prd/spells/iceStorm.html#_ice-storm)_, _ [wall of fire](/pathfinderRPG/prd/spells/wallOfFire.html#_wall-of-fire)_

3rd—_clairaudience_/_clairvoyance_S, _ [dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic)_, _ [displacement](/pathfinderRPG/prd/spells/displacement.html#_displacement)_, _ [greater magic weapon](/pathfinderRPG/prd/spells/magicWeapon.html#_magic-weapon-greater)_OP, _ [hydraulic torrent](/pathfinderRPG/prd/advanced/spells/hydraulicTorrent.html#_hydraulic-torrent-)_, _ [lightning bolt](/pathfinderRPG/prd/spells/lightningBolt.html#_lightning-bolt)_, _ [seek thoughts](/pathfinderRPG/prd/advanced/spells/seekThoughts.html#_seek-thoughts)_, _ [tongues](/pathfinderRPG/prd/spells/tongues.html#_tongues)_S

2nd—_ [arcane lock](/pathfinderRPG/prd/spells/arcaneLock.html#_arcane-lock)_, _ [false life](/pathfinderRPG/prd/spells/falseLife.html#_false-life)_, _ [fox's cunning](/pathfinderRPG/prd/spells/foxSCunning.html#_fox-s-cunning)_OP, _ [locate object](/pathfinderRPG/prd/spells/locateObject.html#_locate-object)_S, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_, _ [scorching ray](/pathfinderRPG/prd/spells/scorchingRay.html#_scorching-ray)_, _ [see invisibility](/pathfinderRPG/prd/spells/seeInvisibility.html#_see-invisibility)_S, _ [touch of idiocy](/pathfinderRPG/prd/spells/touchOfIdiocy.html#_touch-of-idiocy)_

1st—_ [alarm](/pathfinderRPG/prd/spells/alarm.html#_alarm)_, _ [charm person](/pathfinderRPG/prd/spells/charmPerson.html#_charm-person)_, _ [comprehend languages](/pathfinderRPG/prd/spells/comprehendLanguages.html#_comprehend-languages)_S, _ [color spray](/pathfinderRPG/prd/spells/colorSpray.html#_color-spray)_, _ [detect secret doors](/pathfinderRPG/prd/spells/detectSecretDoors.html#_detect-secret-doors)_S, _ [expeditious excavation](/pathfinderRPG/prd/advanced/spells/expeditiousExcavation.html#_expeditious-excavation)_OP, , _ [floating disk](/pathfinderRPG/prd/spells/floatingDisk.html#_floating-disk)_, _ [protection from evil](/pathfinderRPG/prd/spells/protectionFromEvil.html#_protection-from-evil)_, _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_, _ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike)_S, _ [ventriloquism](/pathfinderRPG/prd/spells/ventriloquism.html#_ventriloquism)_
...
7th—_ [control undead](/pathfinderRPG/prd/spells/controlUndead.html#_control-undead)_S, _ [finger of death](/pathfinderRPG/prd/spells/fingerOfDeath.html#_finger-of-death)_S, _ [symbol of weakness](/pathfinderRPG/prd/spells/symbolOfWeakness.html#_symbol-of-weakness)_S, _ [temporary resurrection](../spells/temporaryResurrection.html#_temporary-resurrection)_S,

6th—_ [acid fog](/pathfinderRPG/prd/spells/acidFog.html#_acid-fog)_, _chain lightning_S, , _ [circle of death](/pathfinderRPG/prd/spells/circleOfDeath.html#_circle-of-death)_S, _ [create undead](/pathfinderRPG/prd/spells/createUndead.html#_create-undead)_S, _ [unwilling shield](/pathfinderRPG/prd/advanced/spells/unwillingShield.html#_unwilling-shield)_S,

5th—_ [dismissal](/pathfinderRPG/prd/spells/dismissal.html#_dismissal)_, _ [hold monster](/pathfinderRPG/prd/spells/holdMonster.html#_hold-monster)_, _ [magic jar](/pathfinderRPG/prd/spells/magicJar.html#_magic-jar)_S, _possess object_S, , _ [wall of force](/pathfinderRPG/prd/spells/wallOfForce.html#_wall-of-force)_, _ [waves of fatigue](/pathfinderRPG/prd/spells/wavesOfFatigue.html#_waves-of-fatigue)_S

4th—_ [animate dead](/pathfinderRPG/prd/spells/animateDead.html#_animate-dead)_S, _ [bestow curse](/pathfinderRPG/prd/spells/bestowCurse.html#_bestow-curse)_S, _ [contagion](/pathfinderRPG/prd/spells/contagion.html#_contagion)_S, _ [enervation](/pathfinderRPG/prd/spells/enervation.html#_enervation)_S, _ [shadow projection](/pathfinderRPG/prd/advanced/spells/shadowProjection.html#_shadow-projection)_S, , _ [shout](/pathfinderRPG/prd/spells/shout.html#_shout)_, _ [wall of ice](/pathfinderRPG/prd/spells/wallOfIce.html#_wall-of-ice)_

3rd—_ [gentle repose](/pathfinderRPG/prd/spells/gentleRepose.html#_gentle-repose)_S, _ [halt undead](/pathfinderRPG/prd/spells/haltUndead.html#_halt-undead-copy)_S, _ [lightning bolt](/pathfinderRPG/prd/spells/lightningBolt.html#_lightning-bolt)_, _ [magic circle against good](/pathfinderRPG/prd/spells/magicCircleAgainstGood.html#_magic-circle-against-good)_, _ [nondetection](/pathfinderRPG/prd/spells/nondetection.html#_nondetection)_, _ [ray of exhaustion](/pathfinderRPG/prd/spells/rayOfExhaustion.html#_ray-of-exhaustion)_S, _ [stinking cloud](/pathfinderRPG/prd/spells/stinkingCloud.html#_stinking-cloud)_, _ [vampiric touch](/pathfinderRPG/prd/spells/vampiricTouch.html#_vampiric-touch)_S

2nd—_ [arcane lock](/pathfinderRPG/prd/spells/arcaneLock.html#_arcane-lock)_, _blindness_S, _ [darkness](/pathfinderRPG/prd/spells/darkness.html#_darkness)_, _ [false life](/pathfinderRPG/prd/spells/falseLife.html#_false-life)_S, _ [obscure object](/pathfinderRPG/prd/spells/obscureObject.html#_obscure-object)_, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_, _ [scare](/pathfinderRPG/prd/spells/scare.html#_scare)_S, _ [summon swarm](/pathfinderRPG/prd/spells/summonSwarm.html#_summon-swarm)_

1st—_ [cause fear](/pathfinderRPG/prd/spells/causeFear.html#_cause-fear)_S, _ [chill touch](/pathfinderRPG/prd/spells/chillTouch.html#_chill-touch)_S, _ [floating disk](/pathfinderRPG/prd/spells/floatingDisk.html#_floating-disk)_, _restore corpse_S, , _ [hypnotism](/pathfinderRPG/prd/spells/hypnotism.html#_hypnotism)_, _obscuring fog_, _ [ray of enfeeblement](/pathfinderRPG/prd/spells/rayOfEnfeeblement.html#_ray-of-enfeeblement)_S, _ [sculpt corpse](/pathfinderRPG/prd/advanced/spells/sculptCorpse.html#_sculpt-corpse-)_S, , _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_, _ [sleep](/pathfinderRPG/prd/spells/sleep.html#_sleep)_
...
8th—_ [binding](/pathfinderRPG/prd/spells/binding.html#_binding)_, _ [maze](/pathfinderRPG/prd/spells/maze.html#_maze)_, _ [protection from spells](/pathfinderRPG/prd/spells/protectionFromSpells.html#_protection-from-spells)_S

7th—_ [banishment](/pathfinderRPG/prd/spells/banishment.html#_banishment)_S, _ [delayed blast fireball](/pathfinderRPG/prd/spells/delayedBlastFireball.html#_delayed-blast-fireball)_, _ [expend](/pathfinderRPG/prd/advanced/spells/expend.html#_expend-)_S, , _ [form of the dragon II](/pathfinderRPG/prd/spells/formOfTheDragon.html#_form-of-the-dragon-ii)_, _ [grasping hand](/pathfinderRPG/prd/spells/graspingHand.html#_grasping-hand)_

6th—_ [analyze dweomer](/pathfinderRPG/prd/spells/analyzeDweomer.html#_analyze-dweomer)_, _ [antimagic field](/pathfinderRPG/prd/spells/antimagicField.html#_antimagic-field)_S, _ [chain lightning](/pathfinderRPG/prd/spells/chainLightning.html#_chain-lightning)_, _ [greater dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic-greater)_S, _ [true seeing](/pathfinderRPG/prd/spells/trueSeeing.html#_true-seeing)_

5th—_ [break enchantment](/pathfinderRPG/prd/spells/breakEnchantment.html#_break-enchantment)_S, _ [cone of cold](/pathfinderRPG/prd/spells/coneOfCold.html#_cone-of-cold)_, _ [dismissal](/pathfinderRPG/prd/spells/dismissal.html#_dismissal)_S, _ [polymorph](/pathfinderRPG/prd/spells/polymorph.html#_polymorph)_, _ [summon monster V](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-v)_, _ [wall of force](/pathfinderRPG/prd/spells/wallOfForce.html#_wall-of-force)_

4th—_ [confusion](/pathfinderRPG/prd/spells/confusion.html#_confusion)_, _ [dimension door](/pathfinderRPG/prd/spells/dimensionDoor.html#_dimension-door)_, _ [dimensional anchor](/pathfinderRPG/prd/spells/dimensionalAnchor.html#_dimensional)_S, _ [fire trap](/pathfinderRPG/prd/spells/fireTrap.html#_fire-trap)_S, _ [mass enlarge person](/pathfinderRPG/prd/spells/enlargePerson.html#_enlarge-person-mass)_, _ [secure shelter](/pathfinderRPG/prd/spells/secureShelter.html#_secure-shelter)_, _ [true form](/pathfinderRPG/prd/advanced/spells/trueForm.html#_true-form)_S,

3rd—_ [cloak of winds](/pathfinderRPG/prd/advanced/spells/cloakOfWinds.html#_cloak-of-winds)_S, , _ [daylight](/pathfinderRPG/prd/spells/daylight.html#_daylight)_, _ [enter image](/pathfinderRPG/prd/advanced/spells/enterImage.html#_enter-image-)_, _ [explosive runes](/pathfinderRPG/prd/spells/explosiveRunes.html#_explosive-runes)_S, _ [haste](/pathfinderRPG/prd/spells/haste.html#_haste)_, _ [lightning bolt](/pathfinderRPG/prd/spells/lightningBolt.html#_lightning-bolt)_, _ [magic circle against evil](/pathfinderRPG/prd/spells/magicCircleAgainstEvil.html#_magic-circle-against-evil)_S, _ [water breathing](/pathfinderRPG/prd/spells/waterBreathing.html#_water-breathing)_

2nd—_ [detect thoughts](/pathfinderRPG/prd/spells/detectThoughts.html#_detect-thoughts)_, _ [glitterdust](/pathfinderRPG/prd/spells/glitterdust.html#_glitterdust)_, _ [knock](/pathfinderRPG/prd/spells/knock.html#_knock)_, _ [protection from arrows](/pathfinderRPG/prd/spells/protectionFromArrows.html#_protection-from-arrows)_S, _cushioning bands_, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_S, _ [scorching ray](/pathfinderRPG/prd/spells/scorchingRay.html#_scorching-ray)_, _ [whispering wind](/pathfinderRPG/prd/spells/whisperingWind.html#_whispering-wind)_

1st—_ [animate rope](/pathfinderRPG/prd/spells/animateRope.html#_animate-rope)_, _ [detect secret doors](/pathfinderRPG/prd/spells/detectSecretDoors.html#_detect-secret-doors)_, _ [detect undead](/pathfinderRPG/prd/spells/detectUndead.html#_detect-undead)_, _ [endure elements](/pathfinderRPG/prd/spells/endureElements.html#_endure-elements)_S, _ [feather fall](/pathfinderRPG/prd/spells/featherFall.html#_feather-fall)_, _ [obscuring mist](/pathfinderRPG/prd/spells/obscuringMist.html#_obscuring-mist)_, _ [protection from chaos](/pathfinderRPG/prd/spells/protectionFromChaos.html#_protection-from-chaos)_S, _ [shadow](/pathfinderRPG/prd/magicItems/armor.html#_armor-shadow) blade_S, , _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_S, _ [shocking grasp](/pathfinderRPG/prd/spells/shockingGrasp.html#_shocking-grasp)_, _ [touch of gracelessness](/pathfinderRPG/prd/advanced/spells/touchOfGracelessness.html#_touch-of-gracelessness)_

0—standard plus _ [disrupt undead](/pathfinderRPG/prd/spells/disruptUndead.html#_disrupt-undead)_OP
...
8th—_ [greater](/pathfinderRPG/prd/spells/shadowEvocation.html#_shadow-evocation-greater) [shadow](/pathfinderRPG/prd/magicItems/armor.html#_armor-shadow) evocation_S, _ [mind blank](/pathfinderRPG/prd/spells/mindBlank.html#_mind-blank)_, _ [scintillating pattern](/pathfinderRPG/prd/spells/scintillatingPattern.html#_scintillating-pattern)_S, _ [temporal stasis](/pathfinderRPG/prd/spells/temporalStasis.html#_temporal-stasis)_

7th—_ [finger of death](/pathfinderRPG/prd/spells/fingerOfDeath.html#_finger-of-death)_, _ [greater](/pathfinderRPG/prd/spells/shadowConjuration.html#_shadow-conjuration-greater) [shadow](/pathfinderRPG/prd/magicItems/armor.html#_armor-shadow) conjuration_S, _ [project image](/pathfinderRPG/prd/spells/projectImage.html#_project-image)_S, _ [simulacrum](/pathfinderRPG/prd/spells/simulacrum.html#_simulacrum)_S, _ [spell turning](/pathfinderRPG/prd/spells/spellTurning.html#_spell-turning)_

6th—_ [eyebite](/pathfinderRPG/prd/spells/eyebite.html#_eyebite)_, _ [guards and wards](/pathfinderRPG/prd/spells/guardsAndWards.html#_guards-and-wards)_, _ [limited wish](/pathfinderRPG/prd/spells/limitedWish.html#_limited-wish)_, _ [permanent image](/pathfinderRPG/prd/spells/permanentImage.html#_permanent-image)_S, _ [programmed image](/pathfinderRPG/prd/spells/programmedImage.html#_programmed-image)_S, _ [shadow walk](/pathfinderRPG/prd/spells/shadowWalk.html#_shadow-walk)_S, _ [symbol of persuasion](/pathfinderRPG/prd/spells/symbolOfPersuasion.html#_symbol-of-persuasion)_

5th—_ [cloudkill](/pathfinderRPG/prd/spells/cloudkill.html#_cloudkill)_, _ [mirage arcana](/pathfinderRPG/prd/spells/mirageArcana.html#_mirage-arcana)_S, _ [mind fog](/pathfinderRPG/prd/spells/mindFog.html#_mind-fog)_, _ [nightmare](/pathfinderRPG/prd/spells/nightmare.html#_nightmare)_S, _ [seeming](/pathfinderRPG/prd/spells/seeming.html#_seeming)_S, _ [shadow evocation](/pathfinderRPG/prd/spells/shadowEvocation.html#_shadow-evocation)_S, _ [telekinesis](/pathfinderRPG/prd/spells/telekinesis.html#_telekinesis)_

4th—_ [black tentacles](/pathfinderRPG/prd/spells/blackTentacles.html#_black-tentacles)_, _ [dimension door](/pathfinderRPG/prd/spells/dimensionDoor.html#_dimension-door)_, _ [greater invisibility](/pathfinderRPG/prd/spells/invisibility.html#_invisibility-greater)_S, _ [lesser globe of invulnerability](/pathfinderRPG/prd/spells/globeOfInvulnerability.html#_globe-of-invulnerability-lesser)_, _ [phantasmal killer](/pathfinderRPG/prd/spells/phantasmalKiller.html#_phantasmal-killer)_S, _ [remove curse](/pathfinderRPG/prd/spells/removeCurse.html#_remove-curse)_, _ [scrying](/pathfinderRPG/prd/spells/scrying.html#_scrying)_OP, _ [shadow conjuration](/pathfinderRPG/prd/spells/shadowConjuration.html#_shadow-conjuration)_S

3rd—_ [dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic)_, _ [heroism](/pathfinderRPG/prd/spells/heroism.html#_heroism)_, _ [illusory script](/pathfinderRPG/prd/spells/illusoryScript.html#_illusory-script)_S, _ [magic circle against good](/pathfinderRPG/prd/spells/magicCircleAgainstGood.html#_magic-circle-against-good)_, _ [major image](/pathfinderRPG/prd/spells/majorImage.html#_major-image)_S, _ [phantom steed](/pathfinderRPG/prd/spells/phantomSteed.html#_phantom-steed)_, _ [shrink item](/pathfinderRPG/prd/spells/shrinkItem.html#_shrink-item)_, _ [slow](/pathfinderRPG/prd/spells/slow.html#_slow)_

2nd—_ [arcane lock](/pathfinderRPG/prd/spells/arcaneLock.html#_arcane-lock)_, _ [darkness](/pathfinderRPG/prd/spells/darkness.html#_darkness)_OP, _ [false life](/pathfinderRPG/prd/spells/falseLife.html#_false-life)_, _ [glitterdust](/pathfinderRPG/prd/spells/glitterdust.html#_glitterdust)_, _ [magic mouth](/pathfinderRPG/prd/spells/magicMouth.html#_magic-mouth)_S, _ [mirror image](/pathfinderRPG/prd/spells/mirrorImage.html#_mirror-image)_S, _ [obscure object](/pathfinderRPG/prd/spells/obscureObject.html#_obscure-object)_, _ [phantom trap](/pathfinderRPG/prd/spells/phantomTrap.html#_phantom-trap)_S, _ [whispering wind](/pathfinderRPG/prd/spells/whisperingWind.html#_whispering-wind)_

1st—_ [color spray](/pathfinderRPG/prd/spells/colorSpray.html#_color-spray)_S, _ [disguise self](/pathfinderRPG/prd/spells/disguiseSelf.html#_disguise-self)_S, _ [endure elements](/pathfinderRPG/prd/spells/endureElements.html#_endure-elements)_, _ [feather fall](/pathfinderRPG/prd/spells/featherFall.html#_feather-fall)_, _ [grease](/pathfinderRPG/prd/spells/grease.html#_grease)_, _ [magic aura](/pathfinderRPG/prd/spells/magicAura.html#_magic-aura)_S, _ [minor image](/pathfinderRPG/prd/spells/minorImage.html#_minor-image)_S, _ [obscuring mist](/pathfinderRPG/prd/spells/obscuringMist.html#_obscuring-mist)_, _ [ray of enfeeblement](/pathfinderRPG/prd/spells/rayOfEnfeeblement.html#_ray-of-enfeeblement)_, _ [silent image](/pathfinderRPG/prd/spells/silentImage.html#_silent-image)_S, _ [ventriloquism](/pathfinderRPG/prd/spells/ventriloquism.html#_ventriloquism)_S
...
9th—_ [foresight](/pathfinderRPG/prd/spells/foresight.html#_foresight)_S, _ [freedom](/pathfinderRPG/prd/spells/freedom.html#_freedom)_

8th—_ [demand](/pathfinderRPG/prd/spells/demand.html#_demand)_, _ [discern location](/pathfinderRPG/prd/spells/discernLocation.html#_discern-location)_S, _ [greater prying eyes](/pathfinderRPG/prd/spells/pryingEyes.html#_prying-eyes-greater)_S, _ [trap the soul](/pathfinderRPG/prd/spells/trapTheSoul.html#_trap-the-soul)_

7th—_ [instant summons](/pathfinderRPG/prd/spells/instantSummons.html#_instant-summons)_, _ [greater arcane sight](/pathfinderRPG/prd/spells/arcaneSight.html#_arcane-sight-greater)_S, _ [greater scrying](/pathfinderRPG/prd/spells/scrying.html#_scrying-greater)_S, _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_, _ [vision](/pathfinderRPG/prd/spells/vision.html#_vision)_S

6th—_ [analyze dweomer](/pathfinderRPG/prd/spells/analyzeDweomer.html#_analyze-dweomer)_S, _ [greater dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic-greater)_, _ [guards and wards](/pathfinderRPG/prd/spells/guardsAndWards.html#_guards-and-wards)_, _ [legend lore](/pathfinderRPG/prd/spells/legendLore.html#_legend-lore)_S, _ [repulsion](/pathfinderRPG/prd/spells/repulsion.html#_repulsion)_, _ [true seeing](/pathfinderRPG/prd/spells/trueSeeing.html#_true-seeing)_S

5th—_ [contact other plane](/pathfinderRPG/prd/spells/contactOtherPlane.html#_contact-other-plane)_S, _ [major creation](/pathfinderRPG/prd/spells/majorCreation.html#_major-creation)_, _ [secret chest](/pathfinderRPG/prd/spells/secretChest.html#_secret-chest)_, _ [sending](/pathfinderRPG/prd/spells/sending.html#_sending)_, _ [telepathic bond](/pathfinderRPG/prd/spells/telepathicBond.html#_telepathic-bond)_S, _ [planar adaptation](/pathfinderRPG/prd/advanced/spells/planarAdaptation.html#_planar-adaptation)_OP

4th—_ [bestow curse](/pathfinderRPG/prd/spells/bestowCurse.html#_bestow-curse)_, _ [dimensional anchor](/pathfinderRPG/prd/spells/dimensionalAnchor.html#_dimensional)_, _ [lesser geas](/pathfinderRPG/prd/spells/geasQuest.html#_geas-lesser)_, _ [lesser globe of invulnerability](/pathfinderRPG/prd/spells/globeOfInvulnerability.html#_globe-of-invulnerability-lesser)_, _locate creatur_eS, _ [remove curse](/pathfinderRPG/prd/spells/removeCurse.html#_remove-curse)_, _ [secure shelter](/pathfinderRPG/prd/spells/secureShelter.html#_secure-shelter)_, _ [share senses](/pathfinderRPG/prd/advanced/spells/shareSenses.html#_share-senses)_S,

3rd—_ [arcane sight](/pathfinderRPG/prd/spells/arcaneSight.html#_arcane-sight)_S, _ [blood biography](/pathfinderRPG/prd/advanced/spells/bloodBiography.html#_blood-biography-)_S, , _clairaudience_/_clairvoyanc_eS, _ [explosive runes](/pathfinderRPG/prd/spells/explosiveRunes.html#_explosive-runes)_, _ [secret page](/pathfinderRPG/prd/spells/secretPage.html#_secret-page)_OP, _seek senses_S, , _ [tongues](/pathfinderRPG/prd/spells/tongues.html#_tongues)_S

2nd—_ [continual flame](/pathfinderRPG/prd/spells/continualFlame.html#_continual-flame)_, _ [detect thoughts](/pathfinderRPG/prd/spells/detectThoughts.html#_detect-thoughts)_S, _ [flaming sphere](/pathfinderRPG/prd/spells/flamingSphere.html#_flaming-sphere)_, _ [hold person](/pathfinderRPG/prd/spells/holdPerson.html#_hold-person)_, _ [locate object](/pathfinderRPG/prd/spells/locateObject.html#_locate-object)_S, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_, _ [see invisibility](/pathfinderRPG/prd/spells/seeInvisibility.html#_see-invisibility)_S, _ [summon monster II](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-ii)_
...
9th—_ [gate](/pathfinderRPG/prd/spells/gate.html#_gate)_S, _ [soul bind](/pathfinderRPG/prd/spells/soulBind.html#_soul-bind)_, _ [summon monster IX](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-ix)_S, _ [time stop](/pathfinderRPG/prd/spells/timeStop.html#_time-stop)_, _ [wish](/pathfinderRPG/prd/spells/wish.html#_wish)_

8th—_ [create greater undead](/pathfinderRPG/prd/spells/createGreaterUndead.html#_create-greater-undead)_, _ [horrid wilting](/pathfinderRPG/prd/spells/horridWilting.html#_horrid-wilting)_, _ [greater planar binding](/pathfinderRPG/prd/spells/planarBinding.html#_planar-binding-greater)_S, _ [maze](/pathfinderRPG/prd/spells/maze.html#_maze)_S, _ [screen](/pathfinderRPG/prd/spells/screen.html#_screen)_

7th—_ [banishment](/pathfinderRPG/prd/spells/banishment.html#_banishment)_OP, _ [finger of death](/pathfinderRPG/prd/spells/fingerOfDeath.html#_finger-of-death)_, _ [grasping hand](/pathfinderRPG/prd/spells/graspingHand.html#_grasping-hand)_, _ [greater teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport-greater)_S, _ [reverse gravity](/pathfinderRPG/prd/spells/reverseGravity.html#_reverse-gravity)_, _ [summon monster VII](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-vii)_S

6th—_contagious flames_, _ [disintegrate](/pathfinderRPG/prd/spells/disintegrate.html#_disintegrate)_, _ [greater dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic-greater)_OP, _ [legend lore](/pathfinderRPG/prd/spells/legendLore.html#_legend-lore)_, _ [planar binding](/pathfinderRPG/prd/spells/planarBinding.html#_planar-binding)_S, _ [wall of iron](/pathfinderRPG/prd/spells/wallOfIron.html#_wall-of-iron)_S

5th—_ [cloudkill](/pathfinderRPG/prd/spells/cloudkill.html#_cloudkill)_S, _ [cone of cold](/pathfinderRPG/prd/spells/coneOfCold.html#_cone-of-cold)_, _ [contact other plane](/pathfinderRPG/prd/spells/contactOtherPlane.html#_contact-other-plane)_, _ [hungry pit](/pathfinderRPG/prd/advanced/spells/hungryPit.html#_hungry-pit-)_S, , _ [magic jar](/pathfinderRPG/prd/spells/magicJar.html#_magic-jar)_, _ [overland flight](/pathfinderRPG/prd/spells/overlandFlight.html#_overland-flight)_, _ [permanency](/pathfinderRPG/prd/spells/permanency.html#_permanency)_, _ [secret chest](/pathfinderRPG/prd/spells/secretChest.html#_secret-chest)_S, _ [symbol of pain](/pathfinderRPG/prd/spells/symbolOfPain.html#_symbol-of-pain)_

4th—_ [ball lightning](/pathfinderRPG/prd/advanced/spells/ballLightning.html#_ball-lightning)_, _ [black tentacles](/pathfinderRPG/prd/spells/blackTentacles.html#_black-tentacles)_S, _ [detect scrying](/pathfinderRPG/prd/spells/detectScrying.html#_detect-scrying)_, _ [dimension door](/pathfinderRPG/prd/spells/dimensionDoor.html#_dimension-door)_S, _ [enervation](/pathfinderRPG/prd/spells/enervation.html#_enervation)_, _ [greater invisibility](/pathfinderRPG/prd/spells/invisibility.html#_invisibility-greater)_, _ [resilient sphere](/pathfinderRPG/prd/spells/resilientSphere.html#_resilient-sphere)_, _ [remove curse](/pathfinderRPG/prd/spells/removeCurse.html#_remove-curse)_OP

3rd—_ [blink](/pathfinderRPG/prd/spells/blink.html#_blink)_, _ [daylight](/pathfinderRPG/prd/spells/daylight.html#_daylight)_, _ [enter image](/pathfinderRPG/prd/advanced/spells/enterImage.html#_enter-image-)_, _ [fireball](/pathfinderRPG/prd/spells/fireball.html#_fireball)_, _ [gentle repose](/pathfinderRPG/prd/spells/gentleRepose.html#_gentle-repose)_, _ [secret page](/pathfinderRPG/prd/spells/secretPage.html#_secret-page)_, _ [sepia snake sigil](/pathfinderRPG/prd/spells/sepiaSnakeSigil.html#_sepia-snake-sigil)_S, _ [stinking cloud](/pathfinderRPG/prd/spells/stinkingCloud.html#_stinking-cloud)_S

2nd—_ [darkvision](/pathfinderRPG/prd/spells/darkvision.html#_darkvision)_, _ [false life](/pathfinderRPG/prd/spells/falseLife.html#_false-life)_, _ [glitterdust](/pathfinderRPG/prd/spells/glitterdust.html#_glitterdust)_S, _ [make whole](/pathfinderRPG/prd/spells/makeWhole.html#_make-whole)_, _ [mirror image](/pathfinderRPG/prd/spells/mirrorImage.html#_mirror-image)_, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_OP, _ [see invisibility](/pathfinderRPG/prd/spells/seeInvisibility.html#_see-invisibility)_, _ [summon swarm](/pathfinderRPG/prd/spells/summonSwarm.html#_summon-swarm)_S, _ [web](/pathfinderRPG/prd/spells/web.html#_web)_S

1st—_ [burning hands](/pathfinderRPG/prd/spells/burningHands.html#_burning-hands)_, _ [detect undead](/pathfinderRPG/prd/spells/detectUndead.html#_detect-undead)_, _ [disguise self](/pathfinderRPG/prd/spells/disguiseSelf.html#_disguise-self)_, _ [grease](/pathfinderRPG/prd/spells/grease.html#_grease)_S, _ [mage armor](/pathfinderRPG/prd/spells/mageArmor.html#_mage-armor)_S, _ [magic aura](/pathfinderRPG/prd/spells/magicAura.html#_magic-aura)_, _ [magic missile](/pathfinderRPG/prd/spells/magicMissile.html#_magic-missile)_, r_ay of enfeeblement_, _ [unseen servant](/pathfinderRPG/prd/spells/unseenServant.html#_unseen-servant)_S
...
9th—_ [dominate monster](/pathfinderRPG/prd/spells/dominateMonster.html#_dominate-monster)_S, _ [foresight](/pathfinderRPG/prd/spells/foresight.html#_foresight)_, _ [mage's disjunction](/pathfinderRPG/prd/spells/mageSDisjunction.html#_mage-s-disjunction)_, _ [mass hold monster](/pathfinderRPG/prd/spells/holdMonster.html#_hold-monster-mass)_S, _ [mass suffocation](/pathfinderRPG/prd/advanced/spells/suffocation.html#_suffocation,-mass)_, _ [power word kill](/pathfinderRPG/prd/spells/powerWordKill.html#_power-word-kill)_S, _ [time stop](/pathfinderRPG/prd/spells/timeStop.html#_time-stop)_

8th—_ [binding](/pathfinderRPG/prd/spells/binding.html#_binding)_S, _ [clone](/pathfinderRPG/prd/spells/clone.html#_clone)_, _ [irresistible dance](/pathfinderRPG/prd/spells/irresistibleDance.html#_irresistible-dance)_S, _ [mind blank](/pathfinderRPG/prd/spells/mindBlank.html#_mind-blank)_, _ [polymorph any object](/pathfinderRPG/prd/spells/polymorphAnyObject.html#_polymorph-any-object)_, _ [power word stun](/pathfinderRPG/prd/spells/powerWordStun.html#_power-word-stun)_S, _ [sunburst](/pathfinderRPG/prd/spells/sunburst.html#_sunburst)_

7th—_ [deflection](/pathfinderRPG/prd/advanced/spells/deflection.html#_deflection-)_, _ [greater arcane sight](/pathfinderRPG/prd/spells/arcaneSight.html#_arcane-sight-greater)_, _ [instant summons](/pathfinderRPG/prd/spells/instantSummons.html#_instant-summons)_OP, _ [limited wish](/pathfinderRPG/prd/spells/limitedWish.html#_limited-wish)_, _ [mass hold person](/pathfinderRPG/prd/spells/holdPerson.html#_hold-person-mass)_S, _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_OP, _power world blind_S, _ [resonating word](../spells/resonatingWord.html#_resonating-word)_, _ [symbol of stunning](/pathfinderRPG/prd/spells/symbolOfStunning.html#_symbol-of-stunning)_S

6th—_ [cloak of dreams](/pathfinderRPG/prd/advanced/spells/cloakOfDreams.html#_cloak-of-dreams)_S, , _ [contingency](/pathfinderRPG/prd/spells/contingency.html#_contingency)_, _ [enemy hammer](/pathfinderRPG/prd/advanced/spells/enemyHammer.html#_enemy-hammer-)_, _ [greater dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic-greater)_, _geas_/_quest_S, _ [legend lore](/pathfinderRPG/prd/spells/legendLore.html#_legend-lore)_, _ [mage's lucubration](/pathfinderRPG/prd/spells/mageSLucubration.html#_mage-s-lucubration)_, _ [true seeing](/pathfinderRPG/prd/spells/trueSeeing.html#_true-seeing)_

5th—_ [dismissal](/pathfinderRPG/prd/spells/dismissal.html#_dismissal)_, _ [dominate person](/pathfinderRPG/prd/spells/dominatePerson.html#_dominate-person)_S, _ [fabricate](/pathfinderRPG/prd/spells/fabricate.html#_fabricate)_, _forced hand_, _ [icy prison](../spells/icyPrison.html#_icy-prison)_, _ [feeblemind](/pathfinderRPG/prd/spells/feeblemind.html#_feeblemind)_S, _ [mage's private sanctum](/pathfinderRPG/prd/spells/mageSPrivateSanctum.html#_mage-s-private-sanctum)_, _ [permanency](/pathfinderRPG/prd/spells/permanency.html#_permanency)_, _ [prying eyes](/pathfinderRPG/prd/spells/pryingEyes.html#_prying-eyes)_, _ [teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport)_OP

4th—_ [bestow curse](/pathfinderRPG/prd/spells/bestowCurse.html#_bestow-curse), [crushing despair](/pathfinderRPG/prd/spells/crushingDespair.html#_crushing-despair)_S, _ [dimensional anchor](/pathfinderRPG/prd/spells/dimensionalAnchor.html#_dimensional)_, _ [fear](/pathfinderRPG/prd/spells/fear.html#_fear), [moonstruck](/pathfinderRPG/prd/advanced/spells/moonstruck.html#_moonstruck)_S, , _ [resilient sphere](/pathfinderRPG/prd/spells/resilientSphere.html#_resilient-sphere)_, _ [stone shape](/pathfinderRPG/prd/spells/stoneShape.html#_stone-shape)_, _ [stoneskin](/pathfinderRPG/prd/spells/stoneskin.html#_stoneskin)_

3rd—_ [fireball](/pathfinderRPG/prd/spells/fireball.html#_fireball)_, _ [fly](/pathfinderRPG/prd/spells/fly.html)_, _ [greater magic weapon](/pathfinderRPG/prd/spells/magicWeapon.html#_magic-weapon-greater)_, _ [heroism](/pathfinderRPG/prd/spells/heroism.html#_heroism)_S, _ [loathsome veil](../spells/loathsomeVeil.html#_loathsome-veil)_, _ [nondetection](/pathfinderRPG/prd/spells/nondetection.html#_nondetection)_, _ [protection from energy](/pathfinderRPG/prd/spells/protectionFromEnergy.html#_protection-from-energy)_, _symbol of peace_S, , _ [suggestion](/pathfinderRPG/prd/spells/suggestion.html#_suggestion)_S

2nd—_ [arcane lock](/pathfinderRPG/prd/spells/arcaneLock.html#_arcane-lock)_, _ [continual flame](/pathfinderRPG/prd/spells/continualFlame.html#_continual-flame)_, _ [false life](/pathfinderRPG/prd/spells/falseLife.html#_false-life)_, _ [hideous laughter](/pathfinderRPG/prd/spells/hideousLaughter.html#_hideous-laughter)_S, _ [magic mouth](/pathfinderRPG/prd/spells/magicMouth.html#_magic-mouth)_OP, _ [mirror image](/pathfinderRPG/prd/spells/mirrorImage.html#_mirror-image)_OP, _ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_, _ [rope trick](/pathfinderRPG/prd/spells/ropeTrick.html#_rope-trick)_, _ [see invisibility](/pathfinderRPG/prd/spells/seeInvisibility.html#_see-invisibility)_, _ [touch of idiocy](/pathfinderRPG/prd/spells/touchOfIdiocy.html#_touch-of-idiocy)_S

1st—_ [alarm](/pathfinderRPG/prd/spells/alarm.html#_alarm)_, _ [charm person](/pathfinderRPG/prd/spells/charmPerson.html#_charm-person)_S, _ [feather fall](/pathfinderRPG/prd/spells/featherFall.html#_feather-fall)_, _forced quiet_, _ [hydraulic push](/pathfinderRPG/prd/advanced/spells/hydraulicPush.html#_hydraulic-push-)_, _ [identify](/pathfinderRPG/prd/spells/identify.html#_identify)_, _ [magic missile](/pathfinderRPG/prd/spells/magicMissile.html#_magic-missile)_, _ [memory lapse](/pathfinderRPG/prd/advanced/spells/memoryLapse.html#_memory-lapse)_S, , _ [ray of enfeeblement](/pathfinderRPG/prd/spells/rayOfEnfeeblement.html#_ray-of-enfeeblement)_, _ [shield](/pathfinderRPG/prd/spells/shield.html#_shield)_, _ [unseen servant](/pathfinderRPG/prd/spells/unseenServant.html#_unseen-servant)_OP
