...
**Oath Spells** : 1st—_ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike)_; 2nd—_ [acute senses](/pathfinderRPG/prd/ultimateMagic/spells/acuteSenses.html#_acute-senses)_; 3rd—_ [touch of idiocy](/pathfinderRPG/prd/spells/touchOfIdiocy.html#_touch-of-idiocy)_; 4th—_ [spell immunity](/pathfinderRPG/prd/spells/spellImmunity.html#_spell-immunity)_.
...
**Anchoring Aura (Su)** : At 8th level, a paladin's aura hampers extradimensional travel by evil outsiders. The aura extends 20 feet from the paladin. Evil outsiders attempting to use abilities such as _ [dimension door](/pathfinderRPG/prd/spells/dimensionDoor.html#_dimension-door)_, _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_, or _ [teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport)_ to leave or enter the aura must succeed at a Will save (DC 10 + 1/2 the paladin's level + the paladin's Charisma modifier); failure means the ability does not function, as if the outsider were affected by _ [dimensional anchor](/pathfinderRPG/prd/spells/dimensionalAnchor.html#_dimensional)_. The aura functions only while the paladin is conscious, not if she is unconscious or dead.

Alternatively, as an immediate action, the paladin can expend one use of her smite evil ability to target an evil outsider within 30 feet with _ [dimensional anchor](/pathfinderRPG/prd/spells/dimensionalAnchor.html#_dimensional)_. A targeted _ [dimensional anchor](/pathfinderRPG/prd/spells/dimensionalAnchor.html#_dimensional)_ persists even if the paladin is unconscious or dead.

This ability replaces aura of resolve.

**Holy Vessel (Su)** : At 9th level, a paladin whose divine bond is with a weapon can also use her divine bond to augment her armor or shield with enhancement bonuses, or add any of the following armor or shield properties: _ [bashing](/pathfinderRPG/prd/magicItems/armor.html#_armor-bashing)_, _ [fortification](/pathfinderRPG/prd/magicItems/armor.html#_armor-fortification)_, and _ [spell resistance](/pathfinderRPG/prd/magicItems/armor.html#_armor-spell-resistance)_. Adding these properties consumes an amount of bonus equal to the property's cost (see the [armor special abilities](/pathfinderRPG/prd/magicItems/armor.html#_table-15-4-armor-special-abilities) and [shield special abilities](/pathfinderRPG/prd/magicItems/armor.html#_table-15-5-shield-special-abilities) tables). She can divide her bonuses from the divine bond ability among her weapon, armor, and shield as she sees fit. This ability has no effect for a paladin whose divine bond is with a mount. This ability replaces the mercy gained at 9th level.
...
**Oath Spells** : 1st—_ [resist energy](/pathfinderRPG/prd/spells/resistEnergy.html#_resist-energy)_; 2nd—_ [detect thoughts](/pathfinderRPG/prd/spells/detectThoughts.html#_detect-thoughts)_; 3rd—_ [invisibility purge](/pathfinderRPG/prd/spells/invisibilityPurge.html#_invisibility-purge)_; 4th—_ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_.
...
**Holy Reach (Su)** : At 2nd level, an oathbound paladin can expend one use of her smite evil ability to extend her natural reach by 5 feet for 1 minute. This does not stack with the [Lunge](/pathfinderRPG/prd/feats.html#_lunge) feat. This ability replaces divine grace.

**Hordebreaker (Su)** : At 11th level, when the paladin hits an evil humanoid with an attack of opportunity, she deals an additional 1d6 points of damage. When using holy reach, the paladin may make a number of additional attacks of opportunity per round equal to her Charisma bonus. This increase stacks with similar increases from other sources such as [Combat Reflexes](/pathfinderRPG/prd/feats.html#_combat-reflexes). This ability replaces aura of justice.
...
**Oath Spells** : 1st—_ [deathwatch](/pathfinderRPG/prd/spells/deathwatch.html#_deathwatch)_; 2nd—_ [protection from arrows](/pathfinderRPG/prd/spells/protectionFromArrows.html#_protection-from-arrows)_; 3rd—_ [haste](/pathfinderRPG/prd/spells/haste.html#_haste)_; 4th—_ [divine power](/pathfinderRPG/prd/spells/divinePower.html#_divine-power)_.
...
**Detect Undead (Su)** : This ability works like the standard paladin ability to detect evil, except as _ [detect undead](/pathfinderRPG/prd/spells/detectUndead.html#_detect-undead) _instead of _ [detect evil](/pathfinderRPG/prd/spells/detectEvil.html#_detect-evil)_. This ability replaces _ [detect evil](/pathfinderRPG/prd/spells/detectEvil.html#_detect-evil)_.

**Ghost Touch Aura (Su)** : At 3rd level, the paladin's armor is treated as if it had the _ [ghost touch](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-ghost-touch) _armor property. This does not affect the cost or effect of any other abilities of the armor. At 9th level, this ability also applies to the paladin's shield. This ability replaces the paladin's 3rd-level and 9th-level mercies.
...
**Oath Spells** : 1st—_ [sanctify corpse](/pathfinderRPG/prd/ultimateMagic/spells/sanctifyCorpse.html#_sanctify-corpse)_; 2nd—_ [darkvision](/pathfinderRPG/prd/spells/darkvision.html#_darkvision)_; 3rd—_ [searing light](/pathfinderRPG/prd/spells/searingLight.html#_searing-light)_; 4th—_ [halt undead](/pathfinderRPG/prd/spells/haltUndead.html#_halt-undead-copy)_.
...
**Divine Bond (Sp)** : This works like the paladin's normal divine bond ability, except as follows. If the paladin's bond is with a weapon, she cannot use that ability to add the _ [brilliant energy](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-brilliant-energy)_, _ [disruption](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-disruption)_, or _ [merciful](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-merciful) weapon_ properties, but she can add the _ [bane](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-bane)_ weapon property (but only against dragons). If the paladin's bond is with her steed, the steed gains the paladin's aura-based immunities and her aura does not affect allies. This replaces the standard divine bond ability.

**Dragon-Slaying Strike (Su)** : At 20th level, an oathbound paladin becomes a conduit of holy power. Her DR increases to 10/evil. Whenever she uses smite evil and successfully strikes a dragon, the dragon is also subject to a single-target _ [holy word](/pathfinderRPG/prd/spells/holyWord.html#_holy-word)_, using her paladin level +10 as the caster level. After the banishment effect and the damage from the attack are resolved, the smite immediately ends. In addition, whenever she channels positive energy or uses lay on hands to heal a creature, she heals the maximum possible amount. This ability replaces holy champion.
...
**Oath Spells** : 1st—_ [enlarge person](/pathfinderRPG/prd/spells/enlargePerson.html#_enlarge-person)_; 2nd—_ [bear's endurance](/pathfinderRPG/prd/spells/bearSEndurance.html#_bear-s-endurance)_; 3rd—_ [fly](/pathfinderRPG/prd/spells/fly.html)_; 4th—_ [stoneskin](/pathfinderRPG/prd/spells/stoneskin.html#_stoneskin)_.
...
**Oath Spells** : 1st—_ [magic stone](/pathfinderRPG/prd/spells/magicStone.html#_magic-stone)_; 2nd—_ [make whole](/pathfinderRPG/prd/spells/makeWhole.html#_make-whole)_; 3rd—_ [magic vestment](/pathfinderRPG/prd/spells/magicVestment.html#_magic-vestment)_; 4th—_ [imbue with spell ability](/pathfinderRPG/prd/spells/imbueWithSpellAbility.html#_imbue-with-spell-ability)_.
...
**Pure of Body (Su)** : Upon reaching 8th level, the paladin has a 50% chance to turn any critical hit or sneak attack against her into a normal hit, as if she were wearing _ [fortification](/pathfinderRPG/prd/magicItems/armor.html#_armor-fortification)_ armor. This ability replaces aura of resolve.

**Code of Conduct** : Never engage in a romantic relationship or a sexual act.

**Oath Spells** : 1st—_ [remove fear](/pathfinderRPG/prd/spells/removeFear.html#_remove-fear)_; 2nd—_ [confess](/pathfinderRPG/prd/advanced/spells/confess.html#_confess)_; 3rd—_ [heroism](/pathfinderRPG/prd/spells/heroism.html#_heroism)_; 4th—_ [freedom of movement](/pathfinderRPG/prd/spells/freedomOfMovement.html#_freedom-of-movement)_.
...
**Oath Spells** : 1st—_ [wrath](/pathfinderRPG/prd/advanced/spells/wrath.html#_wrath)_; 2nd—_ [aid](/pathfinderRPG/prd/spells/aid.html#_aid)_; 3rd—_ [helping hand](/pathfinderRPG/prd/spells/helpingHand.html#_helping-hand)_; 4th—_ [sending](/pathfinderRPG/prd/spells/sending.html#_sending)_.
...
**Oath Spells** : 1st—_ [wrath](/pathfinderRPG/prd/advanced/spells/wrath.html#_wrath)_; 2nd—_ [confess](/pathfinderRPG/prd/advanced/spells/confess.html#_confess)_; 3rd—_ [blessing of fervor](/pathfinderRPG/prd/advanced/spells/blessingOfFervor.html#_blessing-of-fervor)_; 4th—_ [order's wrath](/pathfinderRPG/prd/spells/orderSWrath.html#_order-s-wrath)_.
