...
Unless otherwise stated, bonuses granted by a variant channeling are sacred bonuses if you channel positive energy or profane bonuses if you channel negative energy. If an alternative channeled energy provides a âchannel bonusâ on rolls or statistics, the bonus is +1, increasing to +2 at cleric level 5 and for every 5 cleric levels thereafter (to a maximum of +5). Likewise, a âchannel penaltyâ is initially –1, increasing to –2 at cleric level 5 and every 5 cleric levels thereafter (to a maximum of –5).
...
**Air/Sky/Wind** : _Heal_—Creatures gain a channel bonus on [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) and [Fly](/pathfinderRPG/prd/skills/fly.html#_fly) checks, saving throws against wind effects, and effects with the air descriptor until the end of your next turn. _Harm_—Creatures are buffeted with wind until the end of your next turn; this wind gives them a channel penalty on ranged attacks, and their movement is halved if they move toward you.
...
**Art/Music** : _Heal_—Creatures gain a channel bonus on [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) checks and on saving throws against illusions, sonic effects, and language-dependent effects for 1 minute. _Harm_—Creatures take a channel penalty on saving throws against illusions, sonic effects, and language-dependent effects for 1 minute.
...
**Cities** : _Heal_—Creatures gain a channel bonus on attack rolls when flanking and to Armor Class when flanked until the end of your next turn. _Harm_—All creatures' squares and threatened areas are treated as difficult terrain until the start of your next turn (these areas move with the creatures rather than being fixed in place at the time of the channeling). Until the end of your next turn, creatures gain a channel penalty on [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) checks and overrun attempts to move through these squares.
...
**Darkness** : _Heal_—Creatures gain low-light vision until the end of your next turn. At cleric level 5, they gain darkvision 30 feet as well, increasing this range by 30 feet for every 5 cleric levels thereafter. _Harm_—The illumination level in the area drops by 1 step, as _ [darkness](/pathfinderRPG/prd/spells/darkness.html#_darkness)_, for 1 minute. At cleric level 10, the light level drops by 2 steps. At cleric level 15, it drops by 3 steps, and areas of dim light or darkness become supernaturally dark (even creatures with darkvision cannot see within it).
...
**Disease** : _Heal_—Creatures heal a number of points of ability damage to one ability score (your choice) equal to your channel bonus. _Harm_—Creatures are sickened until the end of your next turn, plus a number of rounds equal to your channel penalty. At cleric level 10, you may select one creature as the target of a _ [contagion](/pathfinderRPG/prd/spells/contagion.html#_contagion)_ in addition to the effects of the channeled energy. At cleric level 20, all creatures in the area are subject to _ [contagion](/pathfinderRPG/prd/spells/contagion.html#_contagion)_ in addition to the effects of the channeled energy.

**Dreams** : _Heal_—Creatures affected by sleep effects may attempt another saving throw and apply the channel bonus on the roll. Willingly sleeping creatures gain a channel bonus on saving throws and [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks for up to 8 hours (this bonus ends if the creature awakens). _Harm_—Creatures gain a channel penalty on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks and saving throws against exhaustion, fatigue, and sleep effects for 1 minute.
...
**Envy** : _Heal_—Creatures gain a channel bonus on disarm and steal combat maneuvers, [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) checks, and [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand) checks for 1 minute. _Harm_—Creatures must attempt a steal combat maneuver on their next turn against an adjacent enemy. This is a compulsion effect.
...
**Freedom** : _Heal_—Creatures gain a channel bonus on [Escape Artist](/pathfinderRPG/prd/skills/escapeArtist.html#_escape-artist) checks, CMB checks to escape a grapple, and saving throws against becoming entangled, paralyzed, or slowed. _Harm_—Creatures are slowed (as _ [slow](/pathfinderRPG/prd/spells/slow.html#_slow)_) until the end of your next turn.

**Hunting** : _Heal_—Creatures gain a channel bonus on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks and ranged attack rolls until the end of your next turn. _Harm_—Creatures gain a –5 penalty on [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) checks for 1 minute and temporarily lose effects or special abilities that reduce or negate tracks for that duration.

**Justice/Law** : _Heal_—Lawful creatures gain a channel bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks, attack rolls, and saving throws until the end of your next turn. _Harm_—Creatures are affected by _ [zone of truth](/pathfinderRPG/prd/spells/zoneOfTruth.html#_zone-of-truth)_ until the end of your next turn.

**Knowledge** : _Heal_—Creatures gain a channel bonus on Knowledge and [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks until the end of your next turn. _Harm_—Sentient creatures (Intelligence 3+) who fail their saves take 1d2 points of Intelligence damage. A successful save negates this Intelligence damage.
...
**Nature** : _Heal_—The healing effect is enhanced for animals and fey. Creatures gain a channel bonus on [Handle Animal](/pathfinderRPG/prd/skills/handleAnimal.html#_handle-animal) and wild empathy checks for 1 minute. _Harm_—The harmful effect is enhanced for animals and fey.
...
**Rulership** : _Heal_—Creatures gain a channel bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks and to the DC of their language-dependent and charm effects until the end of your next turn. _Harm_—Creatures are dazed for 1 round.

**Ocean/Sea/Water** : _Heal_—Creatures gain a channel bonus on [Climb](/pathfinderRPG/prd/skills/climb.html#_climb) and [Swim](/pathfinderRPG/prd/skills/swim.html#_swim) checks and Constitution checks to hold their breath; this bonus lasts for 1 minute. Creatures ignore fatigue from thirst and pressure damage from deep water for 1 minute. _Harm_—The harming effect is enhanced for creatures with the aquatic or water subtypes.

**Secrets** : _Heal_—Creatures gain a channel bonus on [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks and caster level checks and to save DCs of their divination spells until the end of your next turn. _Harm_—Creatures gain a channel penalty on saving throws against divinations for 1 minute. Creatures using [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) against affected creatures for the next minute gain a channel bonus on [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks.
...
**Trickery** : _Heal_—Creatures gain a channel bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff), [Disguise](/pathfinderRPG/prd/skills/disguise.html#_disguise), [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand), and [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) checks for 1 minute. _Harm_—Creatures gain a channel penalty on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks for 1 minute.
...
**Class Skills** : The cloistered cleric's class skills are [Appraise](/pathfinderRPG/prd/skills/appraise.html#_appraise) (Int), [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (Int), [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) (Cha), Heal (Wis), Knowledge (all) (Int), [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics) (Int), [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (Wis), [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) (Wis), and [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft) (Int).
...
**[Scribe Scroll](/pathfinderRPG/prd/feats.html#_scribe-scroll) (Su)** : At 4th level, a cloistered cleric gains [Scribe Scroll](/pathfinderRPG/prd/feats.html#_scribe-scroll) as a bonus feat.
...
**Domain Secret (Ex)** : At 5th level, the theologian chooses one domain spell. That spell becomes permanently modified with one of the following metamagic feats: [Bouncing Spell](/pathfinderRPG/prd/advanced/advancedFeats.html#_bouncing-spell-(metamagic)), [Disruptive Spell](/pathfinderRPG/prd/advanced/advancedFeats.html#_disruptive-spell-(metamagic)), [Ectoplasmic Spell](/pathfinderRPG/prd/advanced/advancedFeats.html#_ectoplasmic-spell-(metamagic)), [Enlarge Spell](/pathfinderRPG/prd/feats.html#_enlarge-spell), [Extend Spell](/pathfinderRPG/prd/feats.html#_extend-spell), [Focused Spell](/pathfinderRPG/prd/advanced/advancedFeats.html#_focused-spell-(metamagic)), [Intensified Spell](/pathfinderRPG/prd/advanced/advancedFeats.html#_intensified-spell-(metamagic)), [Silent Spell](/pathfinderRPG/prd/feats.html#_silent-spell), [Still Spell](/pathfinderRPG/prd/feats.html#_still-spell). This metamagic feat does not increase the level of the spell. Once chosen, this modification cannot be changed. The domain specialist need not have the metamagic feat to apply it to a spell using this ability. At every 5 levels after 5th, the domain specialist may choose an additional domain spell to modify in this way. She cannot modify the same spell more than once.
...
**Bonus Feats** : All undead lords gain [Command Undead](/pathfinderRPG/prd/feats.html#_command-undead) as a bonus feat. In addition, at 10th level, she may select one of the following as a bonus feat: [Channel Smite](/pathfinderRPG/prd/feats.html#_channel-smite), [Extra Channel](/pathfinderRPG/prd/feats.html#_extra-channel), [Improved Channel](/pathfinderRPG/prd/feats.html#_improved-channel), [Quick Channel](/pathfinderRPG/prd/ultimateMagic/ultimateMagicFeats.html#_quick-channel), [Skeleton Summoner](/pathfinderRPG/prd/ultimateMagic/ultimateMagicFeats.html#_skeleton-summoner), [Undead Master](/pathfinderRPG/prd/ultimateMagic/ultimateMagicFeats.html#_undead-master).

**Unlife Healer (Su)** : At 8th level, the undead lord's spells, spell-like abilities, and supernatural abilities used to heal undead heal an extra 50% damage. At 16th level, these effects automatically heal the maximum possible damage for the effect + the extra 50%. This does not stack with abilities or feats such as [Empower Spell](/pathfinderRPG/prd/feats.html#_empower-spell) or [Maximize Spell](/pathfinderRPG/prd/feats.html#_maximize-spell).
