...
Dragonhide armor costs twice as much as masterwork armor of that type, but it takes no longer to make than ordinary armor of that type (double all [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) results).
...
Weapons crafted from fire-forged steel similarly channel heat away from the wearer; this does not grant the wielder energy resistance. Instead, the blade absorbs and channels heat to the parts of the weapon that contact enemies. If the weapon is exposed to 10 points or more of fire damage (such as from an opponent's _ [fireball](/pathfinderRPG/prd/spells/fireball.html#_fireball)_ or by holding it in a campfire for 1 full round), the weapon adds +1d4 points of fire damage to its attacks for the next 2 rounds. If the wielder is wearing fire-forged armor and using a fire-forged weapon, this bonus damage increases to 1d6 points of fire damage and lasts for 4 rounds. This bonus damage does not stack with fire damage from weapon enhancements such as _ [flaming](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-flaming)_.
...
Greenwood can be altered or enhanced with wood-shaping magic such as _ [ironwood](/pathfinderRPG/prd/spells/ironwood.html#_ironwood)_, _shape wood_, and _ [warp wood](/pathfinderRPG/prd/spells/warpWood.html#_warp-wood)_. The duration of any such effect on a greenwood item is doubled.
...
A creature carrying a viridium weapon must save every 24 hours or contract leprosy unless the weapon is kept inside an extradimensional space (such as an _ [efficient quiver](/pathfinderRPG/prd/magicItems/wondrousItems.html#_efficient-quiver)_) or a scabbard lined with lead.
