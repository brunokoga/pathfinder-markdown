...
| _ [Read magic](/pathfinderRPG/prd/spells/readMagic.html#_read-magic)_ | +2,000 gp | +1 |
...
| 76–80 | Item can_ [fly](/pathfinderRPG/prd/spells/fly.html), _as the spell, at a speed of 30 feet | +10,000 gp | +2 |
...
| 51–55 | Defeat/slay a particular creature type (see the _ [bane](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-bane)_ special ability for choices) | +2 |
...
| 96–100 | Item can use _ [true resurrection](/pathfinderRPG/prd/spells/trueResurrection.html#_true-resurrection)_ on wielder, once per month | +200,000 gp | +2 |
...
_ [bag of holding](/pathfinderRPG/prd/magicItems/wondrousItems.html#_bag-of-holding) type III_
...
**Alignment** lawful [good](/pathfinderRPG/prd/bestiary3/creatureTypes.html#_good-subtype); **Senses** 30 ft.

**Intelligence** 10; **Wisdom** 13; **Charisma** 12; **Ego** 10

**Language** telepathy (Celestial;_ truespeech_)

This copper rod is made up of constantly grinding gearlike parts. It is believed that these rods may be some alternate or lesser form of harbinger archons. The rod can take may useful forms, and after 24 hours in the possession of a lawful good creature, the wielder can command it to take the form of any tool, including a _ [chime of opening](/pathfinderRPG/prd/magicItems/wondrousItems.html#_chime-of-opening)_. Very intelligent and witty, these rods communicate with their wielders in truespeech or Celestial. Furthermore, the rod has the following powers.

- Three times per day, on command, the rod's wielder can use _ [dimension door](/pathfinderRPG/prd/spells/dimensionDoor.html#_dimension-door)_, as the spell.
...
Craft Rod, _ [dimension door](/pathfinderRPG/prd/spells/dimensionDoor.html#_dimension-door), [knock](/pathfinderRPG/prd/spells/knock.html#_knock), [explosive runes](/pathfinderRPG/prd/spells/explosiveRunes.html#_explosive-runes), _creator must be lawful good
...
A _headband of vast intellect +6_ also holds a consciousness that shares its knowledge and education with a suitable wearer. This intellect can be of any alignment and its only purpose is to share its vast knowledge with its wearer. The headband also functions as a _ [helm of](/pathfinderRPG/prd/magicItems/wondrousItems.html#_helm-of-comprehend-languages-and-read-magic) [comprehend languages](/pathfinderRPG/prd/spells/comprehendLanguages.html#_comprehend-languages) and read magic._ Furthermore, instead of granting the normal skill ranks of a _headband of vast intellect +6_, this headband grants 4 ranks in six skills, but all of those skills must be [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) skills. It grants such intelligence by a stream of constant whispers and arguments that the headband communicates telepathically in Common or in one of 10 other languages it knows. Once per week on command, the wearer can also convince the headband to use _ [legend lore](/pathfinderRPG/prd/spells/legendLore.html#_legend-lore)_ as the spell, though the casting time is only a standard action.

**Construction Requirements**

**Cost** 35,650 GP

Craft Wondrous Item, _ [comprehend languages](/pathfinderRPG/prd/spells/comprehendLanguages.html#_comprehend-languages)_, _ [fox's cunning](/pathfinderRPG/prd/spells/foxSCunning.html#_fox-s-cunning)_, _legend and lore_, _ [read magic](/pathfinderRPG/prd/spells/readMagic.html#_read-magic)_

Helmet of the Golden General

**Price** 62,000 gp; **Aura** strong divination; **CL** 13th; **Weight** 3 lbs.

**Alignment** neutral [good](/pathfinderRPG/prd/bestiary3/creatureTypes.html#_good-subtype); **Senses** 30 ft.
...
- Three times per day, it can affect its wearer or an ally within 30 feet as the _ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike) _spell.
- Three times per day, it can attempt to demoralize all enemies within 30 feet as a free action, as if using the [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) skill. The helmet's [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) is bonus +17.

**Construction Requirements**

**Cost** 31,000 GP

Craft Wondrous Item, the item's performance and teamwork feat, _ [bless](/pathfinderRPG/prd/spells/bless.html#_bless)_, _ [eagle's splendor](/pathfinderRPG/prd/spells/eagleSSplendor.html#_eagle-s-splendor)_, _ [prayer](/pathfinderRPG/prd/spells/prayer.html#_prayer)_, _ [scare](/pathfinderRPG/prd/spells/scare.html#_scare)_, _ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike)_
...
- A _lightning bow_ needs no ammunition. With the pull of a string, it creates a _+3 [shock](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-shock) arrow_ or a _+3 [brilliant energy](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-brilliant-energy) arrow (_the wielder's choice with each shot).
- Three times per day, the wielder can cast _ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike)_ as a swift action. The _ [true strike](/pathfinderRPG/prd/spells/trueStrike.html#_true-strike)_ can only be used with attacks made with the _lightning bow_.
- Three times per day, the wielder can use _ [lightning bolt](/pathfinderRPG/prd/spells/lightningBolt.html#_lightning-bolt)_ as a spell-like ability.

**Construction Requirements**

**Cost** 27,300 GP

Craft Magic Arms and Armor, _ [call lightning](/pathfinderRPG/prd/spells/callLightning.html#_call-lightning)_, the willing service of one Huge lighting elemental for at least 100 years
...
This lute is a masterwork instrument constructed of polished ebony, with mother of pearl embellishments and gold frets. It grants any creature playing it a +2 competence bonus on [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) (string instruments) checks as it gently telepathically whispers ways the creature can improve is current performance. It also grants those who can play the lute the following abilities.

- Three times per day on command, a creature with at least 6 ranks in [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) (string instruments) can play a chord on the lute of discord to employ the _ [murderous command](/pathfinderRPG/prd/ultimateMagic/spells/murderousCommand.html#_murderous-command) _spell.
- Three times per day on command, a creature with at least 6 ranks in [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) (string instruments) can play a chord on the _lute of discord_ to use the _ [distracting cacophony](/pathfinderRPG/prd/ultimateMagic/spells/distractingCacophony.html#_distracting-cacophony)_ spell (3rd level).
- Once per day on command, a creature with at least 6 ranks in [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) (string instruments) can play a chord to use the _ [echolocation](/pathfinderRPG/prd/ultimateMagic/spells/echolocation.html#_echolocation)_ spell (4th level caster)

**Construction Requirements**

**Cost** 18,950 GP

Craft Wondrous Item, _ [distracting cacophony](/pathfinderRPG/prd/ultimateMagic/spells/distractingCacophony.html#_distracting-cacophony)_, _ [echolocation](/pathfinderRPG/prd/ultimateMagic/spells/echolocation.html#_echolocation)_, _ [murderous command](/pathfinderRPG/prd/ultimateMagic/spells/murderousCommand.html#_murderous-command) _
...
The rod can be used as a _+1 [light](/pathfinderRPG/prd/spells/light.html#_light) mace_. On command, it transforms into a _+1/+1 quarterstaff_ or back to its rod form.

A _metamagician's apprentice_ knows four metamagic feats (limited to feats that use a spell slot one or two levels higher than the spell's actual level, such as [Silent Spell](/pathfinderRPG/prd/feats.html#_silent-spell) and [Empower Spell](/pathfinderRPG/prd/feats.html#_empower-spell)) and acts as a _greater metamagic rod_ for those feats. The rod can only apply one metamagic feat to a spell at a time, though (like a _metamagic rod_) the wielder can use his own feats and the rod's on the same spell.

The rod can use _ [read magic](/pathfinderRPG/prd/spells/readMagic.html#_read-magic)_ and _ [detect magic](/pathfinderRPG/prd/spells/detectMagic.html#_detect-magic)_ at will. The _metamagician's apprentice_ is never overwhelmed by powerful magic auras. These abilities do not trigger effects that require reading to activate (such as the _ [explosive runes](/pathfinderRPG/prd/spells/explosiveRunes.html#_explosive-runes)_ spell). The rod grants the wielder a +2 competence bonus on three [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) skills; these skills are determined when the rod is created (and require the apprentice to have ranks in that skill) and can never be changed. [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana) is almost always one of these three skills.
...
- The ring functions as a _ [ring of protection](/pathfinderRPG/prd/magicItems/rings.html#_ring-of-protection) +5_.
...
Forge Ring, _ [shield of faith](/pathfinderRPG/prd/spells/shieldOfFaith.html#_shield-of-faith)_, creator must be 15th level (or 9th level if the creator is a gnome)
...
This _ [caster's shield](/pathfinderRPG/prd/magicItems/armor.html#_caster-s-shield) _always has one arcane scroll and knows the same arcane spells as the wielder. When the spell on the scroll is cast, another scroll of a spell the wielder knows randomly manifests to replace it. The shield has no arcane spell failure. The shield can also _ [read magic](/pathfinderRPG/prd/spells/readMagic.html#_read-magic)_. It will often debate with its wielder for the most devastating course of action, but does what the wielder commands.

**Construction Requirements**

**Cost** 7,250 GP

Craft Magic Arms and Armor, [Scribe Scroll](/pathfinderRPG/prd/feats.html#_scribe-scroll), creator must be an arcane spellcaster of at least 14th level
...
- Three times per day, the _singing sword_ can use the _ [heroic finale](/pathfinderRPG/prd/advanced/spells/heroicFinale.html#_heroic-finale)_ spell.

**Construction Requirements**

**Cost** 500 GP

Craft Arms and Armor, _ [keen edge](/pathfinderRPG/prd/spells/keenEdge.html#_keen-edge),_ _animate object_, the soul of a willing bard of at least 8th level
