...
You can only recruit a team if the character levels of its individual members are equal to or lower than your [Leadership](/pathfinderRPG/prd/feats.html#_leadership) score. Even if you don't have the [Leadership](/pathfinderRPG/prd/feats.html#_leadership) feat, calculate your [Leadership](/pathfinderRPG/prd/feats.html#_leadership) score as your character level + your Charisma modifier.
...
**Teams and Leadership** : One advantage of having followers from the [Leadership](/pathfinderRPG/prd/feats.html#_leadership) feat is that they increase the effect of Influence and Labor you spend in a settlement. As the primary component of the price of recruiting teams is Influence, having followers in a settlement makes it easier to get the word out about the organization you want to build.

The people in your organization obey you because you pay them, or at least keep regular contact with them and direct their activities. Unlike with cohorts and followers gained from the [Leadership](/pathfinderRPG/prd/feats.html#_leadership) feat (who are loyal toward you because of your reputation and behavior), if you're away from your organization for a long period of time, you might lose your connection with it. In the [Upkeep Phase section](/pathfinderRPG/prd/ultimateCampaign/kingdomsAndWar/kingdomBuilding.html#_upkeep-phase), see Step 3—Determine Capital Attrition.
...
**Benefit (Rooms Only)** : This entry lists what non-downtime bonuses the room provides, such skill bonuses or changes to settlement modifiers (such as Corruption, Crime, and Danger). If a room provides a skill bonus, that bonus applies only when you're in the location specified. For example, just because you have a Ballroom in your castle doesn't mean you get its [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) bonus when you're in a dungeon.
...
This room aids you when you're attempting [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (alchemy) checks, researching new alchemist formulae, and performing similar alchemical tasks. Up to three people can use the room at a time.

Altar

**Earnings** Influence +3

**Benefit** counts as a permanent fixture dedicated to your deity for the purpose of _ [consecrate](/pathfinderRPG/prd/spells/consecrate.html#_consecrate)_ and similar spells
...
**Benefit** counts as masterwork artisan's tools for one [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) skill
...
**Benefit** bonus on [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) checks
...
This large room is used for various artistic performances. It contains a stage, costumes, instruments, and seating for an audience. The superior acoustics and dÃ©cor grant a +2 bonus on all [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) checks made in this room.
...
This large open room is intended for dances, receptions, and other elaborate events. The superior acoustics and decor grant a +2 bonus on all [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) checks made in this room.

Bar

**Earnings** gp or Influence +10

**Benefit** bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks to gather information

**Create** 6 Goods, 1 Influence, 5 Labor (250 gp); **Time** 16 days

**Size** 10—20 squares

A Bar stores a selection of drinks and includes a counter for preparing them. After spending an hour with local people in this room, for the next 24 hours you gain a +1 bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks you make to gather information in the settlement.

Bath

**Earnings** gp or Influence +3

**Benefit** bonus on Fortitude saves against [disease](/pathfinderRPG/prd/bestiary3/universalMonsterRules.html#disease)
...
**Benefit** contestant gains a bonus on [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) and performance combat checks
...
**Benefit** bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) checks of one type
...
A Book Repository contains shelves upon shelves of books, in addition to chairs, desks, and tables for reading and studying. Most repositories contain books on a wide array of topics providing a general wealth of information, but some contain books focused on a specific topic. When you construct a Book Repository, select one [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) skill. If someone has a question relating to that [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) skill and is able to spend 1 hour researching in the Book Repository, she gains a +3 bonus on the [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) check to answer the question.
...
**Benefit** bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff), [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks (see below)
...
**Benefit** counts as masterwork artisan's tools for [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) ( [clockwork](/pathfinderRPG/prd/bestiary3/creatureTypes.html#clockwork-subtype))
...
This is a hallway or tunnel leading to a hidden exit from the building. The exit door is typically a simple wooden door with an average lock ( [Disable Device](/pathfinderRPG/prd/skills/disableDevice.html#_disable-device) DC 20 to open). Either or both ends of the hallway can be secret doors ( [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) DC 20 to notice).

False Front

**Earnings** gp or Goods +2

**Benefit** bonus to [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) DCs
...
This simple, nondescript business uses an innocuous front to hide criminal dealings. It might appear to be a low-quality pawnshop or ill-stocked market. It has the bare necessities for functioning as the kind of business it pretends to be, but its true purpose is to conceal the nature of the building—typically a criminal enterprise or secret meeting place, such as a cult's sanctuary or a den of thieves. The room includes a secret door leading to the rest of the building. The room increases [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) DCs by 5 for those trying to notice unusual activity or determine whether the building is what it seems. Since a False Front contains both a false Storefront and false display area, its space can be upgraded to both Storage and a Storefront simultaneously (or upgraded to just one, leaving the remaining area unused).
...
**Benefit** defenders get bonus on initiative and [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks
...
**Benefit** defenders get a bonus on initiative and [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks
...
**Benefit** bonus on Fortitude saves against contracting [disease](/pathfinderRPG/prd/bestiary3/universalMonsterRules.html#disease)
...
**Benefit** bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana), [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft), and spell research checks
...
A Magical Repository is similar to a Book Repository, but specific to the study of the arcane arts. It contains shelves of books, comfortable chairs, and tables for studying and for scribing notes and scrolls. If you construct this room from scratch, it grants someone who studies there for 1 hour a +3 bonus on a [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana) check to answer a question. If you upgrade a Book Repository into this room, you either keep the original Book Repository's bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) checks or change its skill to [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana). An hour of study in this room also grants a +3 bonus on [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft) checks. The room grants an additional +1 bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana) and [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft) checks for spell research (see Research a Spell on page 86) and crafting magic items.
...
**Benefit** bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (geography), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature), and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) checks

**Create** 8 Goods, 9 Labor, 1 Magic (440 gp); **Time** 20 days

**Size** 10—20 squares

This elevated room is open to the sky, has a skylight, or has a retractable roof to allow you to observe the passing of celestial bodies. An Observation Dome includes shelves containing records and notes, a telescope, and other devices dedicated to celestial study. If someone spends 1 hour researching in the Observation Dome, she gains a +2 bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (geography), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature), and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) checks to answer a question about the heavens.
...
**Benefit** bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (religion) checks relating to its contents
...
**Benefit** bonus on [disease](/pathfinderRPG/prd/bestiary3/universalMonsterRules.html#disease) and negative level recovery saves
...
A Scrying Room is built to be a quiet place for scrying, seances, and similar divinations. It contains a table, chairs, and either a pool of water (at no additional cost) or a suitable focus object for a scrying spell (for an additional 1,000 gp). A caster using _ [scrying](/pathfinderRPG/prd/spells/scrying.html#_scrying)_, _ [locate creature](/pathfinderRPG/prd/spells/locateCreature.html#_locate-creature)_, or a similar targeted divination from here increases the spell's DC by 1.
...
**Upgrades From** Vault; **Upgrades To** [Escape Route](/pathfinderRPG/prd/ultimateCombat/ultimateCombatFeats.html#escape-route)
...
**Benefit** bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff), [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local), and [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) checks

**Create** 12 Goods, 12 Labor (480 gp); **Time** 24 days

**Size** 6—10 squares

This is a room used for meeting and entertaining in a relaxed, comfortable setting, such as a den, dining room, or smoking room. It has furnishings appropriate to its function (chairs for a sitting room, table and chairs for a dining room, and so on). By spending an hour conversing with guests in a social manner, the host of the room gains a +1 bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff), [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local), and [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) checks to influence or learn about those guests for the next 24 hours.
...
**Benefit** bonus on Charisma, [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) checks

**Create** 11 Goods, 4 Influence, 10 Labor, 5 Magic (1,040 gp); **Time** 28 days

**Size** 6—16 squares

A Summoning Chamber is used to perform magical rituals to conjure outsiders. It contains a well-drawn, nearly complete magic circle on the floor—which you can complete with just a few chalk marks—suitable for use with _magic circle _spells, _ [planar binding](/pathfinderRPG/prd/spells/planarBinding.html#_planar-binding)_ spells, and so on. A person who uses a Summoning Chamber gains a +3 bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) checks relating to a creature being called or summoned, and a +3 bonus on Charisma checks, [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks, and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks to influence or bargain with a creature called or summoned here.

Throne Room

**Earnings** Influence +15

**Benefit** bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff), [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local), and [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) checks
...
**Benefit** counts as masterwork artisan's tools for one [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) or [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) skill

**Create** 8 Goods, 7 Labor (300 gp); **Time** 16 days

**Size** 8—16 squares

This includes a table, chair, and appropriate masterwork artisan's tools for one [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) or [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) skill you choose when you build the room. For example, if intended for a carpenter, it has clamps, saws, nails, hammers, and a sturdy worktable. Up to three people can use the room at a time.
...
Bureaucrats interface with local government and deal with annoying paperwork related to running a business or organization. This type of team could include accountants, diplomats, lawyers, and scribes. A typical bureaucrat is a 1st-, 2nd-, or 3rd-level expert with ranks in [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff), [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local), [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics), and [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (barrister, clerk, or scribe).
...
Craftspeople are trained in a particular [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) or [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) skill and make a living using that skill. Examples of this team are alchemists, carpenters, leatherworkers, masons, and smiths. A typical carpenter is a 4th-level expert (_Pathfinder RPG NPC Codex_ 261) with 4 ranks each in [Climb](/pathfinderRPG/prd/skills/climb.html#_climb), [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (carpentry), [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (engineering and local). Craftspeople in other fields have a similar skill arrangement.
...
Drivers are trained to handle and move common animals—managing ox-drawn carts, herding cattle, or training riding horses. A Driver is typically 1st-level expert with ranks in [Handle Animal](/pathfinderRPG/prd/skills/handleAnimal.html#_handle-animal), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (geography), [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (driver), [Ride](/pathfinderRPG/prd/skills/ride.html#_ride), and [Survival](/pathfinderRPG/prd/skills/survival.html#_survival).
...
Lackeys wait on you hand and foot and take care of common domestic and traveling issues; their ranks include butlers, valets, maids, heralds, footmen, ladies-in-waiting, and similar service personnel. Skilled Lackeys anticipate your needs and coordinate with your other employees as well as those of your guests or host. A typical Lackey is a 1st-level commoner or expert with ranks in a subset of [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), [Disguise](/pathfinderRPG/prd/skills/disguise.html#_disguise), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nobility), [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics), [Perception](/pathfinderRPG/prd/skills/perception.html#_perception), and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive).
...
Robbers are expert thieves who commit burglary, robbery, and other violent crimes for profit. A typical robber is a 3rd-level expert or rogue with 3 ranks each in [Climb](/pathfinderRPG/prd/skills/climb.html#_climb), [Disable Device](/pathfinderRPG/prd/skills/disableDevice.html#_disable-device), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), [Perception](/pathfinderRPG/prd/skills/perception.html#_perception), and [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth).
...
A sage is a person with extensive knowledge in one or more related areas who can advise you about his areas of expertise. A typical sage is a 3rd-level expert with 3 ranks each in skills such as [Appraise](/pathfinderRPG/prd/skills/appraise.html#_appraise), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge), [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics), [Profession](/pathfinderRPG/prd/skills/profession.html#_profession), and [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft).
...
Sailors know how to sail a ship, navigate while at sea, and defend the vessel against pirates and other hostile boarders. A typical sailor is a 2nd-level expert (_NPC Codex_ 260) with 2 ranks each in [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics), [Climb](/pathfinderRPG/prd/skills/climb.html#_climb), [Perception](/pathfinderRPG/prd/skills/perception.html#_perception), [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (sailor), [Survival](/pathfinderRPG/prd/skills/survival.html#_survival), and [Swim](/pathfinderRPG/prd/skills/swim.html#_swim).
