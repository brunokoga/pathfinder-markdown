...
**Dispelled Battler** : When deprived of magic, you fight harder. You gain a +1 trait bonus on weapon attack and damage rolls while within an area of antimagic such as that created by an _ [antimagic field](/pathfinderRPG/prd/spells/antimagicField.html#_antimagic-field)_. You also gain this bonus for 1 round after you are subject to an area or targeted _ [dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic)_ spell, regardless of the effect's success or failure in dispelling your spells and magical effects.
...
**Hidden Hand** : Your concealed weapons strike fast and true. You gain a +1 trait bonus on [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand) checks made to conceal light weapons and a +1 trait bonus on attack rolls when making an attack with a light weapon during a surprise round.
...
**Larger Than Life** : You wield firearms with truly terrifying menace. When you use the [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) skill on a creature while wielding a firearm, you are considered one size category larger than your actual size.
...
**Nature's Mimic** : Your knowledge of nature informs your fighting style, and that style gives you insight into related aspects of the natural world. You gain a +1 trait bonus on all [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature) checks, and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature) is always a class skill for you. You can make [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature) checks pertaining to animals that correspond to your style feats untrained.
...
**Reckless** : You have a tendency for rash behavior, often disregarding your own safety as you move across the battlefield. You gain a +1 bonus on [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) checks, and [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) is always a class skill for you.
...
**Scarred Descendant** : Your own people are your favored enemy. You gain a +1 trait bonus on rolls to confirm critical hits against favored enemies of your own subtype and on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks made to track such creatures.

**Startling Report** : Through either perfect timing or the determination of your action, the sound of your firearm going off sets your enemies on edge. When you shoot a firearm, you gain a +2 trait bonus on [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks for 1 round against those who heard the shot.
...
**Unblemished Barrel** : Your skill with firearms speeds your repair of such weapons. You gain a +1 trait bonus on [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (alchemy) and [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (weapons) checks, and it takes you only 30 minutes to remove the broken condition from a firearm.

**Vigilant Battler** : You are hard to fool and harder to trick with a feint. You gain a +1 trait bonus on all [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks. This trait bonus increases to +2 when used to counter a feint in combat.
...
**Caretaker** : As the child of an herbalist or an assistant in a temple infirmary, you often had to assist in tending to the sick and wounded. You gain a +1 trait bonus on [Heal](/pathfinderRPG/prd/skills/heal.html#_heal) checks, and [Heal](/pathfinderRPG/prd/skills/heal.html#_heal) is always a class skill for you.

**Child of the Temple** : You have long served at a temple in a city, where you picked up on many of the nobility's customs in addition to spending much time in the temple libraries studying your faith. You gain a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nobility) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (religion) checks, and one of these skills (your choice) is always a class skill for you.

**Devotee of the Green** : Your faith in the natural world or one of the gods of nature makes it easy for you to pick up on related concepts. You gain a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (geography) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature) checks, and one of these skills (your choice) is always a class skill for you.
...
**Omen** : You are the harbinger of some future event. Whether this event bodes good or ill, you exude an ominous presence. You gain a +1 trait bonus on [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks, and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) is always a class skill for you. Once per day, you may attempt to demoralize an opponent as a swift action.
...
**Planar Savant** : You have always had an innate sense of the workings of the planes and their denizens. You may use your Charisma modifier when making [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) checks instead of your Intelligence modifier.

**Principled** : You hold yourself to a strict code of behavior that guides all of your decisions and actions. You take a —2 penalty on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) checks and gain a +2 trait bonus on saving throws against charm, compulsion, and emotion effects.

**Prophesied** : Your coming was foretold in prophecy, and people familiar with your legend regard you with awe and fear. You gain a +1 trait bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks when interacting with anyone familiar with you or your reputation.
...
**Scholar of the Great Beyond** : Your greatest interests as a child did not lie with current events or the mundane—you have always felt out of place, as if you were born in the wrong era. You take to philosophical discussions of the Great Beyond and of historical events with ease. You gain a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (history) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) checks, and one of these skills (your choice) is always a class skill for you.

**Schooled Inquisitor** : Your additional training aids in identifying the wiles of your faith's enemies. You gain a +2 trait bonus on all [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (religion) checks made to identify the abilities and weaknesses of creatures.

**Spirit Sense** : You are so attuned to the spiritual world that it is hard to get the jump on you. You gain a +2 trait bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks to avoid being surprised and to detect invisible or incorporeal creatures.
...
**Wanderer's Shroud** : Your wanderings often go unnoticed. Efforts to use the [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) skill to gather information about you take a —1 penalty, and you gain a +1 trait bonus on all saving throws against scrying and mind-reading effects that allow saving throws.
...
**Alchemical Adept:** You are skilled in creating alchemical items. You gain a +2 trait bonus on all [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (alchemy) checks made to craft alchemical items. Furthermore, when you fail a [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (alchemy) check by 5 or more but don't roll a natural 1, you don't ruin any raw materials or have to pay that cost again.

**Alchemical Intuition** : You are often struck with epiphanies about alchemical processes and substances. Once per day as a free action, you may gain a trait bonus equal to your Charisma modifier (minimum 0) on a [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (alchemy) check you make. You can apply this bonus after you roll the check, possibly turning a failure into a success.
...
**Bladed Magic** : You have an innate talent for using magical weaponry and those weapons capable of becoming magical. You gain a +1 trait bonus on [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) checks made to craft magic or masterwork weapons. In addition, when you use your arcane pool class ability to grant a weapon an enhancement bonus, that bonus lasts for 2 minutes instead of 1.

**Classically Schooled** : Your apprenticeship or early education was particularly focused on the direct application of magic. You gain a +1 trait bonus on [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft) checks, and [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft) is always a class skill for you.
...
**Dangerously Curious** : You have always been intrigued by magic, possibly because you were the child of a magician or priest. You often snuck into your parent's laboratory or shrine to tinker with spell components and magic devices, and frequently caused quite a bit of damage and headaches for your parent as a result. You gain a +1 bonus on [Use Magic Device](/pathfinderRPG/prd/skills/useMagicDevice.html#_use-magic-device) checks, and [Use Magic Device](/pathfinderRPG/prd/skills/useMagicDevice.html#_use-magic-device) is always a class skill for you.
...
**Eldritch Delver** : You have an unquenchable thirst for knowledge about the world and desire to obtain it firsthand. You gain a +1 trait bonus on all [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (dungeoneering) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (history) checks, and you may treat your caster level as 1 level higher for all conjuration spells of the teleportation subschool.
...
**Knowledgeable Caster** : Once per day when you cast a divination spell, you can cast that spell as if your caster level were 1 level higher in the appropriate class. You also gain a +1 trait bonus on any [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) checks associated with your sorcerer bloodline, if any.
...
**Magic Crafter** : Your early magical training involved study of the properties and creation of magic items. You gain a +1 trait bonus on [Appraise](/pathfinderRPG/prd/skills/appraise.html#_appraise) checks and a +1 bonus on any [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) checks attempted while making magic items.
...
**Mathematical [Prodigy](/pathfinderRPG/prd/ultimateMagic/ultimateMagicFeats.html#prodigy)** : Mathematics has always come easily for you, and you have always been able to "see the math" in the physical and magical world. You gain a +1 bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (engineering) checks, and one of these skills (your choice) is always a class skill for you.
...
**Outcast's Intuition** : You are able to sense the motives of others and use that sense to bolster your magic against dispelling. You gain a +1 trait bonus on [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks, and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) is always a class skill for you. In addition, your caster level is treated as 1 level higher for the purposes of any attempts to dispel your magic.

**Partial Protege** : You are adept at disguising your true talents. You gain a +1 trait bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) checks and on [Use Magic Device](/pathfinderRPG/prd/skills/useMagicDevice.html#_use-magic-device) checks made to emulate a class feature.

**Perfectionist's Brew** : You know that potion recipes should be followed with exact precision. You gain a +2 trait bonus on all [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (alchemy) checks and on [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft) checks made to brew potions.

**Possessed** : You were, or are, possessed in some way by another entity that grants you occasional access to its knowledge. Once per day, you can attempt a [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) check of your choice even if you are not trained in that skill and it is not usually possible to use that skill untrained. If you can normally use that skill untrained, you gain a +2 trait bonus on the check.

**Pragmatic Activator** : While some figure out how to use magical devices with stubborn resolve, your approach is more pragmatic. You may use your Intelligence modifier when making [Use Magic Device](/pathfinderRPG/prd/skills/useMagicDevice.html#_use-magic-device) checks instead of your Charisma modifier.

**Precise Treatment** : You treat others with a clear and calculating intellect. You gain a +1 trait bonus on all [Heal](/pathfinderRPG/prd/skills/heal.html#_heal) checks, and you may use your Intelligence modifier when making [Heal](/pathfinderRPG/prd/skills/heal.html#_heal) checks instead of your Wisdom modifier.

**Reluctant Apprentice** : Your early training grants you knowledge of the arcane. You gain a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana) checks, and are considered trained in that skill even if you have no ranks in it.
...
**Self-Taught Scholar** : Being self-taught has made it necessary for you to scour all documentation you can get your hands on. You gain a +1 trait bonus on [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics) checks to decipher unfamiliar languages, and [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics) is always a class skill for you. In addition, you gain a +1 trait bonus on [Spellcraft](/pathfinderRPG/prd/skills/spellcraft.html#_spellcraft) checks made to decipher the writing on a scroll.

**Shrouded Casting** : You have learned the secret to casting some spells without lesser material components. Choose one school of magic when you pick this trait. You can cast spells from that school as if you had the [Eschew Materials](/pathfinderRPG/prd/feats.html#_eschew-materials) feat.
...
**Twinned Presence** : Your eidolon—and your connection to it—makes others ill at ease. You gain a +1 trait bonus on [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks, and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) is always a class skill for you. In addition, if your eidolon is summoned and within 30 feet, and its size exceeds your own, use its size modifier on any [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks you make.
...
**Unseen but Not Undone** : Without a single gesture, you can unleash a bloodline spell. Once per day, you can cast a bloodline spell as if you had the [Still Spell](/pathfinderRPG/prd/feats.html#_still-spell) feat. Using this trait does not modify the spell's level.
...
<th>d6</th>
<th>Result</th>
</tr></thead>| 1 | The unstable mutagen lasts for 5 minutes per alchemist level. |
...
**Acrobat** : Having trained from a young age, you're capable of amazing feats of daring. You gain a +1 bonus on [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) checks, and you take only a —2 penalty instead of the normal —5 penalty when using the [Climb](/pathfinderRPG/prd/skills/climb.html#_climb) skill to attempt an accelerated climb.
...
**Ambitious** : You exude confidence in the presence of those more powerful than you—sometimes unreasonably so. You gain a +4 trait bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks made to influence creatures with at least 5 Hit Dice more than you possess.

**Artisan** : You spent time working under artisans, or your parents were artisans who were particularly skilled at their trade. You gain a +2 trait bonus on a single [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) skill (your choice).

**Bastard** : You were born out of wedlock. You have always been an outsider in society, and in your own family. This perspective has sharpened your insight. You gain a +1 trait bonus on [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks, and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) is always a class skill for you.

**Beast Bond** : You share a close bond with animals. You gain a +1 bonus on [Handle Animal](/pathfinderRPG/prd/skills/handleAnimal.html#_handle-animal) checks and [Ride](/pathfinderRPG/prd/skills/ride.html#_ride) checks. One of these skills (your choice) is always a class skill for you.

**Bruising Intellect** : Your sharp intellect and rapier-like wit bruise egos. [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) is always a class skill for you, and you may use your Intelligence modifier when making [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks instead of your Charisma modifier.

**Bully** : You grew up in an environment where the meek were ignored and you often had to resort to threats or violence to be heard. You gain a +1 trait bonus on [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks, and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) is always a class skill for you.

**Canter** : You grew up among thieves and scoundrels, and their unusual speech patterns and turns of phrase don't faze you in the slightest. Anyone who attempts to use [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) to deliver a secret message to you gains a +5 bonus on her [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) check. When you attempt to intercept a secret message using [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive), you gain a +5 trait bonus on the attempt.

**Charming** : Blessed with good looks, you've come to depend on the fact that others find you attractive. You gain a +1 trait bonus when you use [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) or [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) on a character that is (or could be) sexually attracted to you, and a +1 trait bonus to the save DC of any language-dependent spell you cast on such characters or creatures.

**Child of the Streets** : You grew up on the streets of a large city, and as a result you have developed a knack for picking pockets and hiding small objects on your person. You gain a +1 trait bonus on [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand) checks, and [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand) is always a class skill for you.

**Civilized** : You are well versed in the local laws, customs, and politics. You gain a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nobility) checks and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) checks. [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) is always a class skill for you.

**Criminal** : You spent your early life robbing and stealing to get by. Select one of the following skills: [Disable Device](/pathfinderRPG/prd/skills/disableDevice.html#_disable-device), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), or [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand). You gain a +1 trait bonus on that skill, and it is always a class skill for you.

**Destined Diplomat** : Your relationship with your eidolon gives you some clout with other outsiders. You gain a +2 trait bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks toward outsiders, and [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) is always a class skill for you.

**Fast Talker** : You had a knack for getting yourself into trouble as a child, and as a result developed a silver tongue at an early age. You gain a +1 trait bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) checks, and [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) is always a class skill for you.

**Friend in Every Town** : You have no problem making friends and learning information from them wherever you go. You gain a +1 trait bonus on all [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) checks and [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks. One of these skills (your choice) is always a class skill for you.
...
**Harvester** : You were trained to harvest all parts of an animal with care and precision. You gain a +1 trait bonus on [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (tanner) or [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (trapper) checks, and you may make these checks as if you were trained in the skill even if you have no ranks. Additionally, you do not risk poisoning yourself whenever you handle or apply poison taken from a venomous creature.

**Imposing Scion** : The reputation of your bloodline grants you a degree of fearful respect. You gain a +1 trait bonus on [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks. If your bloodline is keyed to a specific creature type, your trait bonus increases to +2 when interacting with creatures of that type.

**Influence** : Your position in society grants you special insight into others, and special consideration or outright awe from others. Choose one of the following skills: [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), or [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive). You gain a +1 trait bonus on that skill, and it is always a class skill for you.

**Knowing the Enemy** : You know a good deal about your most dire enemies. You gain a +1 trait bonus on checks with the [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) skill corresponding to your first favored enemy choice, and that [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) skill is always a class skill for you.
...
**Mentored** : A tutor or private instructor guided you in learning your art, profession, or trade, and through your education, you became capable of teaching and guiding others. Choose a single [Craft](/pathfinderRPG/prd/skills/craft.html#_craft), [Perform](/pathfinderRPG/prd/skills/perform.html#_perform), or [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) skill. You gain a +1 trait bonus on checks with that skill. You also gain a +1 trait bonus when you aid another's skill check with any skill.

**Mercenary** : For everything there is a price, and you are a negotiator at heart. You gain a +2 trait bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks made while negotiating payment for a quest or a service that you provide.

**Merchant** : You lived your life as a merchant, buying and selling goods. You gain a +1 trait bonus on any [Appraise](/pathfinderRPG/prd/skills/appraise.html#_appraise) and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks you attempt while bargaining for the price of goods. [Appraise](/pathfinderRPG/prd/skills/appraise.html#_appraise) is always a class skill for you.

**Natural-Born Leader** : You've always found yourself in positions where others look up to you as a leader, and you can distinctly remember an event from your early childhood where you led several other children to accomplish a goal that each of you individually could not. All cohorts, followers, or summoned creatures under your leadership gain a +1 morale bonus on Will saves to avoid mind-affecting effects. If you ever take the [Leadership](/pathfinderRPG/prd/feats.html#_leadership) feat, you gain a +1 trait bonus to your [Leadership](/pathfinderRPG/prd/feats.html#_leadership) score.

**Ordinary** : The only thing extraordinary about your appearance is its ordinariness. You carry yourself in an understated way, and many people who see your face soon forget it. You gain a +4 trait bonus on [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) checks whenever you attempt to hide in a crowd.

**Orphaned** : You grew up separated from your birth parents, and had to learn to watch out for yourself. You gain a +1 trait bonus on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks, and [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) is always a class skill for you.

**Poverty-Stricken** : Your childhood was tough, and your parents always had to make every copper piece count. Hunger was your constant companion, and you often had to live off the land or sleep in the wild. You gain a +1 bonus on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks, and [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) is always a class skill for you.
...
**Savage** : You were born and raised in untamed lands far from civilization. You learned to survive in the elements among brutal humanoids and beasts. You gain a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature) checks and a +1 trait bonus on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks to get along in the wild. [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature) is always a class skill for you.

**Seeker** : You are always on the lookout for reward and danger. You gain a +1 trait bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks, and [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) is always a class skill for you.

**Simple Disciple** : You picked up skill in a craft or a profession during your time at a monastery. You gain a +1 trait bonus on checks with a [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) or [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) skill of your choice.

**Style Sage** : You have a passion for history and news concerning monastic disciplines. You gain a +1 trait bonus on checks with your choice of either [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) or [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (history), and the one you choose is always a class skill for you. In addition, you gain a +1 trait bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks made to gather information about any person with levels in monk.

**Suspicious** : You discovered at an early age that someone you trusted, perhaps an older sibling or a parent, had lied to you, and lied often, about something you had taken for granted, leaving you quick to question the claims of others. You gain a +1 trait bonus on [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks, and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) is always a class skill for you.

**Talented** : You are a virtuoso musician, actor, or storyteller. You gain a +1 trait bonus on checks with a single [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) skill (your choice), and all [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) skills are always class skills for you.
...
**Trustworthy** : People find it easy to put their faith in you. You gain a +1 trait bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) checks made to fool someone. You also gain a +1 trait bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks, and [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) is always a class skill for you.

**Truth's Agent** : You are skilled at weeding out information. You gain a +1 trait bonus on all [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks made to gather information and all [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) checks. [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) is always a class skill for you.

**Unintentional Linguist** : You can speak with outsiders. You gain a +1 trait bonus on all [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics) checks, and you begin play knowing one of the following languages (in addition to those granted by your race and Intelligence modifier): Abyssal, Aquan, Celestial, Ignan, Infernal, Protean, or Terran.

**Unnatural Revenge** : You gain a +2 trait bonus on all [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks against creatures of the animal, fey, or plant type, and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) is always a class skill for you.

**Unpredictable** : Your actions often seem random and chaotic to others, but there is a method to your madness. You gain a +1 trait bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) checks, and [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) is always a class skill for you.

**Veiled Disciple** : Trained in espionage, you're skilled at passing messages and staying on task. You gain a +1 trait bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) checks made to pass secret messages and a +1 trait bonus on saving throws against charm and compulsion effects.

**Weathered Emissary** : Your travels in the wildlands gave you insight into how to survive their dangers and communicate with their inhabitants. You gain a +1 trait bonus on all [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics) and [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks, and [Linguistics](/pathfinderRPG/prd/skills/linguistics.html#_linguistics) is always a class skill for you.
...
**Brewmaster** : Your family brought the secrets of dwarven brewing to non-dwarven lands. Though this has given you skill in the brewer's craft, it's also earned you distrust among dwarven purists. You gain a +1 trait bonus on [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (brewer) and [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (alchemy) checks, but you take a —1 penalty on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks made to change the attitude of dwarves who know that your family has shared brewing secrets with non-dwarves.

**Goldsniffer** : Your keen senses lead you to hidden treasures. You gain a +2 trait bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks related to metals, jewels, and gemstones.
...
**Animal Friend** : You've long been a friend to animals, and feel safer when animals are nearby. You gain a +1 trait bonus on Will saving throws as long as an animal (Tiny or larger, must be at least indifferent toward you) is within 30 feet, and [Handle Animal](/pathfinderRPG/prd/skills/handleAnimal.html#_handle-animal) is always a class skill for you.

**Rapscallion** : You've spent your entire life thumbing your nose at the establishment and take pride in your run-ins with the law. Somehow, despite all your mischievous behavior, you've never been caught. You gain a +1 trait bonus on [Escape Artist](/pathfinderRPG/prd/skills/escapeArtist.html#_escape-artist) checks and a +1 trait bonus on initiative checks.
...
**Freedom Fighter** : Your parents allowed escaping slaves to hide in your home, and the stories you've heard from them instilled into you a deep loathing of slavery. You gain a +1 trait bonus on any skill check or attack roll made during the process of escaping capture or in helping a slave escape bondage, and [Escape Artist](/pathfinderRPG/prd/skills/escapeArtist.html#_escape-artist) is always a class skill for you.

**Well-Informed** : You make it a point to know everyone and to be connected to everything around you. You frequent the best taverns, attend all of the right events, and graciously help anyone who needs it. Because of this, you gain a +1 trait bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks to gather information and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) checks. One of these skills (your choice) is always a class skill for you.

### Half-Orc Race Traits

Only half-orcs can select these traits.

**Almost Human** : You have enough human features that it's easy for you to pass for a pureblooded human. You gain a +4 trait bonus on [Disguise](/pathfinderRPG/prd/skills/disguise.html#_disguise) checks to pass as human, and [Disguise](/pathfinderRPG/prd/skills/disguise.html#_disguise) is always a class skill for you.
...
**Outcast** : Driven from town after town because of your heritage, you have become adept at living apart from others. You gain a +1 trait bonus on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) skill checks, and [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) is always a class skill for you.

**Scrapper** : A childhood spent scrabbling for every possession and scrap of food has made you fierce and wary. You receive a +1 trait bonus on all [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks made to demoralize opponents and a +1 trait bonus on all [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks to avoid being surprised.

### Human Race Traits

Only humans can select these traits.

**Scholar of Ruins** : From the moment you could walk and talk, the ruins of ancient civilizations have fascinated you. Because of this, you have special insight into geography as well as expertise in exploring lost places. You gain a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (geography) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (dungeoneering) checks. One of these skills (your choice) is always a class skill for you.

**World Traveler** : Your family has taken the love of travel to an extreme, roaming the world extensively. You've seen dozens of cultures and have learned to appreciate the diversity of what the world has to offer. Select one of the following skills: [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local), or [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive). You gain a +1 trait bonus on checks with that skill, and it is always a class skill for you.
...
**Blood of Dragons** : Long ago, your ancestors' blood mixed with that of dragons. Choose one of the following: gain a +1 trait bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks, gain low-light vision, or gain a +2 trait bonus on saving throws against effects that cause sleep or paralysis.
...
**Fiend Blood** : The blood of fiends taints your line, manifesting physically, though it may be barely noticeable. Choose one of the following skills: [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), or [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes). You gain a +1 trait bonus on checks with that skill, and it is always a class skill for you.
...
**Frontier-Forged (Any Frontier Area)** : A hard life on the edge of civilization has made you resourceful but has also given you a streak of self-preservation bordering on paranoia. You receive a +1 trait bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks and a +1 bonus on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks made to get along in the wild.

**Highlander (Hills or Mountain)** : You were born and raised in rugged badlands or hills, and you've become something of an expert at evading the predators, monsters, and worse that haunt the highlands. You gain a +1 trait bonus on [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) checks, and [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) is always a class skill for you. This trait bonus increases to +2 in hilly or rocky areas.

**Log Roller (Forest)** : The time you spent leaping between slippery logs as they whirled down the river to market taught you how to keep your footing. You gain a +1 trait bonus on [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) checks and a +1 trait bonus to your CMB when attempting to resist trip attacks.

**Militia Veteran (Any Town or Village)** : Your first job was serving in a civilian militia in your hometown. The skills you learned through daily drilling and protecting your fellow townsfolk gave you special insight into military life. Select one of the following skills: [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (soldier), [Ride](/pathfinderRPG/prd/skills/ride.html#_ride), or [Survival](/pathfinderRPG/prd/skills/survival.html#_survival). You gain a +1 trait bonus on checks with that skill, and it is always a class skill for you.

**River Rat (Marsh or River)** : You learned to swim right after you learned to walk. When you were a youth, a gang of river pirates put you to work swimming in nighttime rivers and canals with a dagger between your teeth so you could sever the anchor ropes of merchant vessels. You gain a +1 trait bonus on damage rolls with a dagger and a +1 trait bonus on [Swim](/pathfinderRPG/prd/skills/swim.html#_swim) checks. [Swim](/pathfinderRPG/prd/skills/swim.html#_swim) is always a class skill for you.

**Savanna Child (Plains)** : You were born and raised on the rolling plains or savannas. You spent much of your youth exploring these vast reaches and know many of the region's secrets. Pick one of the following skills: [Handle Animal](/pathfinderRPG/prd/skills/handleAnimal.html#_handle-animal), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature), or [Ride](/pathfinderRPG/prd/skills/ride.html#_ride). You gain a +1 trait bonus on checks with that skill, and it is always a class skill for you.

**Sea-Souled (Coastline or Island)** : You are at home at sea. You receive a +1 trait bonus on [Swim](/pathfinderRPG/prd/skills/swim.html#_swim) checks, and you can always take 10 while Swimming.
...
**Vagabond Child (Urban)** : You grew up among the outcasts and outlaws of your society, learning to forage and survive in an urban environment. Select one of the following skills: [Disable Device](/pathfinderRPG/prd/skills/disableDevice.html#_disable-device), [Escape Artist](/pathfinderRPG/prd/skills/escapeArtist.html#_escape-artist), or [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand). You gain a +1 trait bonus on checks with that skill, and it is always a class skill for you.
...
**Asmodean Demon Hunter (Asmodeus)** : Raised in the church of Asmodeus (whether or not you are currently a follower), you've focused your indoctrinated fervor primarily on the elimination of demons. You gain a +3 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) checks about demons and a +2 trait bonus on Will saves against mind-affecting spells and effects from demons.

**Calistrian Courtesan (Calistria)** : You worked in one of Calistria's temples as a sacred courtesan, and you know how to flatter, please, and (most of all) listen. You gain a +1 trait bonus on [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks and [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks to gather information, and one of these skills (your choice) is always a class skill for you.

**Child of Nature (Gozreh)** : You have been blessed by Gozreh to be as comfortable in the wilderness as you are at home. You gain a +2 trait bonus on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks to find food and water, and a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (nature) checks. One of these skills (your choice) is always a class skill for you.
...
**Ear for Music (Shelyn)** : You spent countless hours of your youth in one of Shelyn's temples, listening to wonderful musicians and singers. You gain a +1 trait bonus on one category of [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) checks and a +2 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) checks that deal with the local art or music scene.

**Eyes and Ears of the City (Abadar)** : Your religious training involved serving in the city watch of a large city, the primary duty of which was standing sentinel on a city wall. You gain a +1 trait bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks, and [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) is always a class skill for you.
...
**Guardian of the Forge (Torag)** : Torag's sacred duties are to protect the faithful, take lessons from the great craftsmen and strategists of the past, and prepare against dark times. You receive a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (engineering) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (history) checks. One of these skills (your choice) is a class skill for you.
...
**Patient Optimist (Erastil)** : You know that all things pass in time, and are used to having to repeat arguments multiple times to convince stubborn believers. You gain a +2 trait bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks to influence hostile or unfriendly creatures, and if you fail at such an attempt, you may retry it once.

**Shadow Whispers (Norgorber)** : You have a penchant for just knowing others' secrets. You gain a +1 trait bonus on [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) checks and a +2 trait bonus on [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks made to demoralize opponents.

**Starchild (Desna)** : Desna sensed your love of travel and promised you would always be able to find your way home. You can automatically determine where true north is. You gain a +4 trait bonus on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks to avoid becoming lost.
...
**Voice of Monsters (Lamashtu)** : Your faith leads you to see the power and wonder in even the most horrible abominations. Once per day, you can cast _ [speak with animals](/pathfinderRPG/prd/spells/speakWithAnimals.html#_speak-with-animals)_. When you cast this spell, it can affect animals (as normal) as well as aberrations and magical beasts with an Intelligence of 2 or lower.
...
**Dependent** : You are dependent upon the acceptance of others. Whenever you fail a [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) check, you become shaken for 1 hour.
...
**Pride** : You can't abide challenges to your dignity, authority, or honor. When someone threatens, accuses, or challenges you, you take a —2 penalty on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks involving that creature until the creature apologizes to you.

**Provincial** : You have only one way of looking at things: the right way. You take a —2 penalty on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks made against all creatures whose religion or alignment differs from your own.

**Sentimental** : You are sentimental, and your thoughts often stray to the past at inappropriate times. You take a —2 penalty on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks to avoid being surprised and on Reflex saving throws to avoid traps or hazards.
...
**Xenophobic** : You have a hard time understanding and trusting those with unfamiliar ways and appearances. You take a —2 penalty on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks made against creatures of a different race or from a different culture.
