...
This _+4 determination_ _heavy steel [shield](/pathfinderRPG/prd/spells/shield.html#_shield) _has the preserved head of a medusa mounted in its center, its eyes shut tight. It grants its wearer a +4 resistance bonus on saving throws and immunity to gaze attacks. When the wearer fights defensively or uses [Combat Expertise](/pathfinderRPG/prd/feats.html#_combat-expertise), the shield's bonuses to AC and on saving throws increase to +6. When she's taking the total defense action, the bonuses increase to +10.

As a standard action, the wearer of the _aegis_ can expend one use of mythic power to awaken the medusa's head, causing its serpentine hair to writhe and its glowing, red eyes to open. This unleashes a cone of widened _ [fear](/pathfinderRPG/prd/spells/fear.html#_fear)_ in the direction of the wearer's choice. The head remains awakened for 1 round per tier the wearer possesses, during which the wearer gains a petrifying gaze like that of the medusa's (turn to stone permanently, 30 feet), except the effect is caused by meeting the gaze of the shield's mounted head rather than the bearer's gaze.
...
_Blade of Courage_: All allies within the area of effect are treated as if affected by of a _ [blessing of courage and life](/pathfinderRPG/prd/advanced/spells/blessingOfCourageAndLife.html#_blessing-of-courage-and-life)_ spell.

_Blade of Castigation_: All opponents within the area fall to their knees as if affected by a _ [castigate](/pathfinderRPG/prd/advanced/spells/castigate.html#_castigate)_ spell.

_Blade of Despair_: All opponents within the area of effect that hear the sound become saddened as if affected by a _ [crushing despair](/pathfinderRPG/prd/spells/crushingDespair.html#_crushing-despair) _spell.

_Blade of Fear_: All opponents within the area of effect that hear the sound become frightened as if affected by a _ [fear](/pathfinderRPG/prd/spells/fear.html#_fear) _spell.

_Blade of Rage_: All opponents within the area of effect that hear the sound become enraged as if affected by a _ [rage](/pathfinderRPG/prd/spells/rage.html#_rage) _spell.
...
While this _+3 [seeking](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-seeking) arrow_ is carried, it grants its bearer a +2 luck bonus on saving throws and skill checks. The wielder doubles her favored enemy bonus on attack and damage rolls against any creature of that type she attacks with the arrow.
...
The graft wearer can expend one use of mythic power to gain telepathy with a range of 100 feet for 2 hours (_Bestiary_ 300) or cast any of the following spells: _ [chaos hammer](/pathfinderRPG/prd/spells/chaosHammer.html#_chaos-hammer), [confusion](/pathfinderRPG/prd/spells/confusion.html#_confusion), [dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic), [mirror image](/pathfinderRPG/prd/spells/mirrorImage.html#_mirror-image), [reverse gravity](/pathfinderRPG/prd/spells/reverseGravity.html#_reverse-gravity), _or _ [true seeing](/pathfinderRPG/prd/spells/trueSeeing.html#_true-seeing)_.

By expending two uses, he can cast _ [greater teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport-greater)_ (self plus 50 pounds of objects only), _ [veil](/pathfinderRPG/prd/spells/veil.html#_veil) _(self only), or _ [unholy blight](/pathfinderRPG/prd/spells/unholyBlight.html#_unholy-blight)._

By expending three uses, he can cast _ [power word stun](/pathfinderRPG/prd/spells/powerWordStun.html#_power-word-stun)_ or summon (level 4, either 1 glabrezu 30% or 1d2 vrocks 70%; _Bestiary_ 300).
...
- As a standard action, the bearer can use _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_ to move herself and up to seven other willing creatures to any plane she is familiar with by expending one use of mythic power. If traveling to a location she's already visited, she can reduce the inaccuracy of _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift) _by expending two uses of mythic power when she does so, in which case she appears 1d6–1 miles (minimum 0 miles) from her destination.
- As a standard action, the bearer can touch another creature with the _nexus crystal_ and expend three uses of mythic power to use _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_ to move the target to a random plane (Reflex DC 27 negates).
- As a standard action, the bearer can expend two uses of mythic power to create a widened _ [dimensional lock](/pathfinderRPG/prd/spells/dimensionalLock.html#_dimensional-lock)_ centered on the crystal instead of on a point in space. The lock lasts for 24 hours or until dismissed.
- As a full-round action, the bearer can attempt to draw back other creatures that teleported away by expending four uses of mythic power. If she succeeds at a DC 40 [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (planes) check, the bearer can draw back up to one creature per mythic tier she possesses that departed via a conjuration (teleportation) effect in the previous round. To draw back a creature, the bearer must be within 15 feet of the location the creature left from. If the creature resists, it can attempt a Will save (DC 25 + the bearer's tier) to avoid returning. The bearer can choose freely which creatures from a group to pull back, and can even pull back creatures that departed with different means or to different destinations, as long as their points of departure are within range.

Destruction

A _nexus crystal_ can be destroyed by invoking its _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_ power as the bearer steps through a _ [gate](/pathfinderRPG/prd/spells/gate.html#_gate)_. Doing so destroys the crystal and the _ [gate](/pathfinderRPG/prd/spells/gate.html#_gate)_, and the resulting magical explosion causes 18d10 points of damage to creatures within a 2-mile-radius burst of either side of the _ [gate](/pathfinderRPG/prd/spells/gate.html#_gate)_ (Reflex DC 27 for half damage). Permanent gates between planes could potentially be destroyed in this fashion, at the GM's discretion.
...
When used as a weapon, the _rod of spell sundering_ functions as a masterwork light mace. On a successful attack, it targets the creature struck with _ [greater dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic-greater)_, with a caster level equal to its bearer's character level plus her mythic tier. This effect can also be delivered with a successful melee touch attack made using the rod.

Destruction

A _rod of spell sundering_ can be destroyed by leaving it within an area devoid of all magic for a year and a day. After this, it must be broken across the knee of a spellcaster formerly capable of casting at least 5th-level spells who lost her powers by using _ [mage's disjunction](/pathfinderRPG/prd/spells/mageSDisjunction.html#_mage-s-disjunction)_ on an artifact.

Screaming Spear of the Sun

**Slot** none; **CL** 20th; **Weight** 4 lbs.; **Aura** strong divination and enchantment

This _+4 [wounding](/pathfinderRPG/prd/magicItems/weapons.html#_wounding) [throwing](/pathfinderRPG/prd/magicItems/weapons.html#_throwing) longspear_ has a 2-foot-long iron spearhead covered with over 30 cruel flesh barbs. On a critical hit, the barbs lodge in the victim's flesh and can be removed only by tearing the blade free. Yanking the blade free is a full-round action that requires a successful Strength check with a DC equal to the attack roll that struck the critical hit, and deals 3d6 points of damage to the victim.

In the hands of a mythic creature, the spear gains the _ [returning](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-returning)_ special ability, and when thrown seemingly comes alive, screaming wickedly as it flies. When it hits a creature, it radiates _ [fear](/pathfinderRPG/prd/spells/fear.html#_fear)_ (as the spell) in a 60-foot-radius burst surrounding the creature struck.
...
- _ [Arcane lock](/pathfinderRPG/prd/spells/arcaneLock.html#_arcane-lock)_
- _ [Arcane sight](/pathfinderRPG/prd/spells/arcaneSight.html#_arcane-sight)_
- _ [Daylight](/pathfinderRPG/prd/spells/daylight.html#_daylight)_
- _ [Knock](/pathfinderRPG/prd/spells/knock.html#_knock)_
- _ [Mage armor](/pathfinderRPG/prd/spells/mageArmor.html#_mage-armor)_
- _ [Mage hand](/pathfinderRPG/prd/spells/mageHand.html#_mage-hand)_
- _ [Touch of idiocy](/pathfinderRPG/prd/spells/touchOfIdiocy.html#_touch-of-idiocy)_

The following powers drain 1 charge per use:

- _ [Black tentacles](/pathfinderRPG/prd/spells/blackTentacles.html#_black-tentacles)_
- _ [Cone of cold](/pathfinderRPG/prd/spells/coneOfCold.html#_cone-of-cold)_ (15d6 damage, Reflex DC 20 half)
- _ [Fireball](/pathfinderRPG/prd/spells/fireball.html#_fireball)_ (10d6 damage, Reflex DC 18 half)
- _ [Greater dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic-greater)_
- _ [Greater invisibility](/pathfinderRPG/prd/spells/invisibility.html#_invisibility-greater)_
- _ [Greater teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport-greater)_
- _ [Lightning arc](/pathfinderRPG/prd/ultimateMagic/spells/lightningArc.html#_lightning-arc)_ (15d6 damage, Reflex DC 20 half)
- _ [Major image](/pathfinderRPG/prd/spells/majorImage.html#_major-image)_ (Will DC 18 disbelief)
- _ [Suggestion](/pathfinderRPG/prd/spells/suggestion.html#_suggestion)_ (Will DC 18 negates)

These powers drain 2 charges per use:

- _ [Summon monster IX](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-ix)_ (the summoned creatures receive the benefits of the [Augment Summoning](/pathfinderRPG/prd/feats.html#_augment-summoning) feat)
- _ [Plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_ (Will DC 22 negates, arrive 2 to 200 miles from the intended destination)
- _ [Prismatic sphere](/pathfinderRPG/prd/spells/prismaticSphere.html#_prismatic-sphere)_ (DC 24)
- _ [Prismatic spray](/pathfinderRPG/prd/spells/prismaticSpray.html#_prismatic-spray)_ (DC 22)

For 5 charges, the _staff of arcane sovereignty_ creates a _ [gate](/pathfinderRPG/prd/spells/gate.html#_gate)_.
...
The wielder can use any of her metamagic feats on spells cast with the _staff of eldritch sovereignty_ by expending 1 charge per increase in spell level, with a minimum of 1 charge spent. The adjusted level of the spell can't be increased above 9th level. For example, a user with [Quicken Spell](/pathfinderRPG/prd/feats.html#_quicken-spell) can spend 5 charges to cast a quickened _ [cone of cold](/pathfinderRPG/prd/spells/coneOfCold.html#_cone-of-cold)_ with the staff, but couldn't use it to cast quickened _ [greater teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport-greater)_.

The wielder can expend one use of mythic power to gain the benefit of a number of charges equal to her mythic tier. Any excess charges are lost. For example, a 5th-tier wielder with [Empower Spell](/pathfinderRPG/prd/feats.html#_empower-spell) could expend one use of mythic power to cast an empowered _ [fireball](/pathfinderRPG/prd/spells/fireball.html#_fireball)_ without consuming any charges from the staff. A wielder who knows the mythic version of one of the staff's spells can cast such spells from the staff by expending one use of mythic power. This can be combined with using mythic power to provide charges. Finally, the wielder can expend one use of mythic power to add 1 charge to the staff, with no risk of explosion if the staff is already fully charged.

A _staff of eldritch sovereignty_ gives the wielder spell resistance equal to 23 plus her tier. If this is willingly lowered, however, the staff can be used to absorb arcane energy directed at its wielder, as a _ [rod of absorption](/pathfinderRPG/prd/magicItems/rods.html#_rod-of-absorption)_ does. Unlike the rod, this staff converts spell levels into charges rather than retaining them as spell energy usable by a spellcaster. If the staff absorbs enough energy to exceed its limit of 50 charges, it explodes as if the wielder had performed a retributive strike (see Destruction). The wielder has no idea how many spell levels are cast at her—the staff doesn't communicate this knowledge as a _ [rod of absorption](/pathfinderRPG/prd/magicItems/rods.html#_rod-of-absorption) _does. Thus, absorbing spells can be risky.
...
This simple neck ring consists of a silver braid with matching ivory ends sculpted to resemble wolf's heads. The torc allows itself to be worn by only a mythic character who swears absolute service to his deity. Thereafter, the torc cannot be removed until its wearer dies. The wearer gains an enhancement bonus to his Charisma score equal to half his tier (minimum 1). Once per day, he can use the torc to cast _ [commune](/pathfinderRPG/prd/spells/commune.html#_commune) _for the purpose of contacting his deity. Lastly, he can expend one use of his mythic power to cast _ [legend lore](/pathfinderRPG/prd/spells/legendLore.html#_legend-lore)._

If the wearer violates his deity's code of ethics, the torc constricts and begins suffocating him until he dies or receives an _ [atonement](/pathfinderRPG/prd/spells/atonement.html#_atonement)_ spell.
...
A mythic character can use a _witherfang's _stolen mythic power to activate her own mythic abilities or to enhance the blade with the following abilities: _ [bane](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-bane)_, _ [dancing](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-dancing)_, _ [speed](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-speed)_, and _ [wounding](/pathfinderRPG/prd/magicItems/weapons.html#_wounding)_. Each ability lasts for 24 hours, and only one can be applied to the blade within each 24-hour period. The wielder can increase _the witherfang's_ enhancement bonus by 1 for each use of mythic power she expends. Alternately, the wielder can expend one use of mythic power to imbue the blade with the _ [bane](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-bane)_ special ability, two uses to imbue it with the _ [wounding](/pathfinderRPG/prd/magicItems/weapons.html#_wounding) _special ability, three uses to imbue it with the _ [speed](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-speed)_ special ability, or four uses to imbue it with the _ [dancing](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-dancing)_ special ability.
...
Only a creature bearing the _Apocalypse Box's _curse can open it. Once per day, the cursed creature can open the box and draw forth a single item her heart desires. The item must be nonmagical, weigh no more than 50 pounds, and be worth no more than 50,000 gp, but is otherwise limited only by the parameters of the _ [wish](/pathfinderRPG/prd/spells/wish.html#_wish)_ spell. A mythic character can expend two uses of mythic power to draw forth a second such item each day.

Each time the _Apocalypse Box_ is opened, there is a 50% chance that instead of granting a _ [wish](/pathfinderRPG/prd/spells/wish.html#_wish)_, the box summons a number of horrific monsters that immediately attack anyone in sight and remain to wreak havoc on the Material Plane for 1 week before returning to their plane of origin. Roll on Table 5–1 below to determine the monsters that appear.
...
This _+6 [keen](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-keen) [speed](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-speed) adamantine dagger_ was constructed in defiance of the gods and their chosen mortal champions, for _Legendsbane_ was created to slay mythic creatures. _Legendsbane_ bypasses all types of damage reduction, and deals an additional 3d6 points of damage to mythic creatures and to non-mythic creatures that have epic DR. This additional damage is multiplied for critical hits.

Non-mythic characters can wield _Legendsbane_ normally. However, when a mythic character first attempts to wield the dagger, she must succeed at a DC 25 Fortitude save or suffer the effects of a _ [destruction](/pathfinderRPG/prd/spells/destruction.html#_destruction)_ spell. If the mythic character survives, she can wield the dagger normally.

_Legendsbane_ imparts upon its wielder the ability to track down mythic creatures she has hunted before. At will, the wielder can cast _ [locate creature](/pathfinderRPG/prd/spells/locateCreature.html#_locate-creature)_ to find a specific mythic creature known to the wielder.

Destruction

_Legendsbane_ can be destroyed if it's anointed in the blood of a slain 10th-rank mythic creature and then struck three times by a _ [vorpal](/pathfinderRPG/prd/magicItems/weapons.html#_vorpal)_ weapon. This act also destroys the _ [vorpal](/pathfinderRPG/prd/magicItems/weapons.html#_vorpal)_ weapon.
...
The _Nimbus of Radiant Truth _exists only when good has need of a great champion. Such a champion can attain it only though a perilous quest that tests mettle and righteousness. Rather than being a physical object, the _Nimbus of Radiant Truth _manifests as a glowing halo of light around the wearer's head. It's ordinarily as bright as _ [continual flame](/pathfinderRPG/prd/spells/continualFlame.html#_continual-flame)_, but in battle it brightens to the dazzling brilliance of _ [daylight](/pathfinderRPG/prd/spells/daylight.html#_daylight)_. Its radiance is treated as resulting from a 9th-level spell for purposes of interaction with other sources of light and darkness. The radiance of the nimbus can be suppressed or resumed as a standard action.
...
- The wearer can bring forth a _ [zone of truth](/pathfinderRPG/prd/spells/zoneOfTruth.html#_zone-of-truth) _(DC 20) with a 40-foot radius at will. By expending one use of mythic power, the DC increases to 30.
...
- Seven times per day, the wearer can _ [cure moderate wounds](/pathfinderRPG/prd/spells/cureModerateWounds.html#_cure-moderate-wounds)_ as a cleric with a caster level equal to her character level. The wearer adds her mythic tier to the hit points healed.
- Three times per day, the wearer can unleash a _ [holy aura](/pathfinderRPG/prd/spells/holyAura.html#_holy-aura)_ (DC 25) or an empowered _ [holy smite](/pathfinderRPG/prd/spells/holySmite.html#_holy-smite)_ (DC 22).
- Once per day, the wearer can unleash a blast of righteous power. Treat this as _ [sunburst](/pathfinderRPG/prd/spells/sunburst.html#_sunburst)_ (DC 27) centered on the wearer, except that it has no effect on good-aligned creatures and inflicts double damage to evil-aligned creatures. After this power is used, the nimbus fades to a barely visible glow for 1 hour, and the wearer loses access to all of its powers save its enhancement bonuses. She remains unable to lie.
- Once per week, the wearer can expend one use of mythic power to perform a _ [resurrection](/pathfinderRPG/prd/spells/resurrection.html#_resurrection)_.
...
- As part of using an ability that requires him to expend mythic power, the host can target a mythic creature within 30 feet. If that creature fails a DC 23 Fortitude save, it contracts a random disease (as _ [contagion](/pathfinderRPG/prd/spells/contagion.html#_contagion)_) and one use of its mythic power is stolen and granted to the host. If the host fails to steal mythic power, he must expend double the usual amount of his own mythic power or the ability fails.
- The host can use _ [contagion](/pathfinderRPG/prd/spells/contagion.html#_contagion)_ heightened to 8th level (DC 23) at will.
- The host can use empowered _ [vampiric touch](/pathfinderRPG/prd/spells/vampiricTouch.html#_vampiric-touch) _three times per day.
- As a swift action, the host can expend one use of mythic power to gain the effects of _ [death ward](/pathfinderRPG/prd/spells/deathWard.html#_death-ward)_, _ [divine power](/pathfinderRPG/prd/spells/divinePower.html#_divine-power)_, and _ [spell resistance](/pathfinderRPG/prd/magicItems/armor.html#_armor-spell-resistance)_. These effects last 1 round per tier he possesses and can't be dispelled.
...
When infecting a host, it has full access to its host's senses, along with darkvision and blindsense with a range of 120 feet. When not in a host, _Plaguebringer_ has only limited awareness, with hearing and blindsense usable to a range of 30 feet and no vision. When not infecting a host, _Plaguebringer_ is undetectable by normal vision due to its microscopic size, though _ [detect evil](/pathfinderRPG/prd/spells/detectEvil.html#_detect-evil)_ reveals its presence. It can fly at a speed of 30 feet, and can infect a new host by entering its body. If the target fails a DC 30 Fortitude save, _Plaguebringer_ infects it and the creature gains access to the artifact's powers_._ If the target succeeds, _Plaguebringer_ can't attempt to infect it again for 1 month.

_Plaguebringer_ can leave a host by becoming dominant and choosing to leave. Immediately after it leaves, the host is affected by multiple _ [contagion](/pathfinderRPG/prd/spells/contagion.html#_contagion)_ effects (DC 30), one for each of the diseases listed in the spell.
...
Once bonded, the scepter can be wielded as a _+6 [brilliant energy](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-brilliant-energy) [light](/pathfinderRPG/prd/spells/light.html#_light) mace_ that grants a +4 enhancement bonus to its bonded owner's Charisma score. In addition, the owner can expend one use of mythic power and ring the scepter's bells to produce the following effects:

- The wielder can ring the bell of authority to cast _ [command](/pathfinderRPG/prd/spells/command.html#_command)_ targeting any non-mythic creature.
- The wielder can ring the bell of banishment to cast _ [dismissal](/pathfinderRPG/prd/spells/dismissal.html#_dismissal)_ upon any non-mythic outsider with a CR at least 3 less than the wielder's total class level plus her tier.
- The wielder can ring the bell of dominion to cast _ [sanctuary](/pathfinderRPG/prd/spells/sanctuary.html#_sanctuary)_ on any non-mythic creature.
- The wielder can ring the bell of imprisonment to cast _ [forcecage](/pathfinderRPG/prd/spells/forcecage.html#_forcecage)_ on any non-mythic creature with a CR at least 3 less than the wielder's total class level plus her tier.
...
Implanting the _Shadowwraith Heart_ into the chest of a dying mythic hero reanimates the heart, restoring the hero as the _ [heal](/pathfinderRPG/prd/spells/heal.html#_heal)_ spell (CL 15th), though the hero loses all mythic tiers.
...
At will, the captain can expend two uses of mythic power to launch the _Silver Maiden _into outer space. Once in space, the ship can sail through the vacuum at incredible speeds. Although exact travel times vary, a voyage between two planets within a solar system takes 2d20 days, and a voyage to another star system takes 2d20 weeks (or more at the GM's discretion). The captain must know which world she wishes to travel to (as if the captain cast _ [greater teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport-greater)_). When the ship arrives at its destination, it slowly descends to the surface (as the _ [feather fall](/pathfinderRPG/prd/spells/featherFall.html#_feather-fall)_ spell), and typically lands in a body of water. Once earthbound, the ship moves as a standard sailing ship. If the planet has no water or comparable liquid, the ship lands on solid ground and is unable to move until the captain once again launches the ship back into space.

The _Silver Maiden _can also sail the Outer Planes. At will, the captain can expend three uses of mythic power to transport the ship to another plane, as the _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift)_ spell. When the ship arrives at its extraplanar destination, it appears in a body of water or comparable liquid, 1 to 100 miles from the captain's intended destination. If the plane has no water (such as the Plane of Earth) the ship appears on solid ground, and is unable to move until the captain transports it to another plane. If the plane has neither water nor a solid surface, such as the Plane of Air, the ship continues to slowly fall (as the _ [feather fall](/pathfinderRPG/prd/spells/featherFall.html#_feather-fall)_ spell) until the captain transports it to another plane.
...
- At will, the wearer can use _ [greater invisibility](/pathfinderRPG/prd/spells/invisibility.html#_invisibility-greater)_ as a spell-like ability for as long a duration as desired.
- At will, the wearer can change his appearance in the same fashion as a _ [hat of disguise](/pathfinderRPG/prd/magicItems/wondrousItems.html#_hat-of-disguise)_, with a DC 25 Will save required to disbelieve the illusion. If the _Tarnhelm_ is used to create a disguise, the wearer receives a +25 bonus on the [Disguise](/pathfinderRPG/prd/skills/disguise.html#_disguise) check.
- Three times per day, the wearer can use _ [greater teleport](/pathfinderRPG/prd/spells/teleport.html#_teleport-greater)_, exactly as if he had cast the spell of the same name. The wearer can teleport additional times by expending one use of mythic power per teleport.
- Three times per day, the wearer can assume the form of an animal as though he had cast _ [beast shape IV](/pathfinderRPG/prd/spells/beastShape.html#_beast-shape-iv)_, except the duration lasts until the effect is dismissed or dispelled. The wearer can change shape additional times by expending one use of mythic power per transformation.
- By expending two uses of mythic power, the wearer can assume the form of Gargantuan chromatic or metallic dragon. The effect lasts until dispelled or dismissed. He gains a +14 size bonus to Strength, a +12 size bonus to Constitution, a +10 natural armor bonus, a fly speed of 150 feet (poor), blindsense 90 feet, darkvision 180 feet, a breath weapon, DR 15/magic, frightful presence (DC 23), one bite (4d6), two claws (2d8), two wing attacks (2d6), and one tail slap (2d8). All his breath weapons deal 16d8 points of damage and allow a Reflex save (DC 10 plus his tier plus his Constitution modifier) for half damage. This ability otherwise functions as _ [form of the dragon III](/pathfinderRPG/prd/spells/formOfTheDragon.html#_form-of-the-dragon-iii)_.

Destruction

The _Tarnhelm_ can be destroyed by being struck by a succession by hammer blows from a dwarven smith wielding an adamantine hammer, a human smith with a steel hammer, and an elven smith using a hammer of spun glass. Each must succeed at a DC 30 [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (armor) check when landing the blow. Failure destroys the hammer, disrupts the attempt to destroy the _Tarnhelm_, and deals 12d6 points of damage to the smith.
...
Labor at the _Trueforge_ requires both supreme skill and mythic power. Non-mythic creatures are affected as the _ [feeblemind](/pathfinderRPG/prd/spells/feeblemind.html#_feeblemind)_ spell (DC 30) for daring to use the forge, and can't use the forge's abilities even if they succeed at their saving throws.
