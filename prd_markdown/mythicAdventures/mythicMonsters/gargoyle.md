...
_This living stone [statue](/pathfinderRPG/prd/spells/statue.html#_statue) takes the shape of a horned and winged humanoid, and green acid drips from its mouth. _

Mythic Gargoyle CR 5/MR 2

XP 1,600

CE Medium monstrous humanoid ( [earth](/pathfinderRPG/prd/monsters/creatureTypes.html#_earth-subtype), [mythic](/pathfinderRPG/prd/mythicAdventures/mythicMonsters.html#_mythic-subtype))
...
**Special Attacks** [breath weapon](/pathfinderRPG/prd/monsters/universalMonsterRules.html#_breath-weapon) (60-ft. line, 6d6 acid damage, Reflex DC 15 half, usable every 1d4 rounds), mythic power (2/day, surge +1d6)
...
**Freeze (Ex)** A gargoyle can hold itself so still it appears to be a statue. A gargoyle that uses freeze can take 20 on its [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) check to hide in plain sight as a stone statue.
