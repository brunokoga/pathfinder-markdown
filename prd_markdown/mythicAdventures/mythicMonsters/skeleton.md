...
**Defensive Abilities** channel resistance +2; **DR** 5/bludgeoning; **Immune** [cold](/pathfinderRPG/prd/monsters/creatureTypes.html#_cold-subtype), undead traits
...
A mythic skeleton is an animated corpse created with mythic magic such as _mythic [animate dead](/pathfinderRPG/prd/spells/animateDead.html#_animate-dead)_. It has an unnatural cunning that belies its mindless nature and a natural instinct for killing.
...
**Hit Dice** : A mythic skeleton's Hit Dice are determined as though it were a [zombie](/pathfinderRPG/prd/monsters/zombie.html#_zombie) instead of a skeleton.
...
**Mythic Bloody Skeleton** : Destroying a mythic bloody skeleton in the area of a non-mythic _ [bless](/pathfinderRPG/prd/spells/bless.html#_bless)_ spell doesn't prevent it from returning to unlife.
