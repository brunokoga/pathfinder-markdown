[Archmage](/pathfinderRPG/prd/mythicAdventures/mythicHeroes/archmage.html) [Champion](/pathfinderRPG/prd/mythicAdventures/mythicHeroes/champion.html) [Guardian](/pathfinderRPG/prd/mythicAdventures/mythicHeroes/guardian.html) [Heirophant](/pathfinderRPG/prd/mythicAdventures/mythicHeroes/hierophant.html) [Marshal](/pathfinderRPG/prd/mythicAdventures/mythicHeroes/marshal.html) [Trickster](/pathfinderRPG/prd/mythicAdventures/mythicHeroes/trickster.html)
...
The GM is free to invent any sort of event to serve as the moment of ascension, as required by the needs of the campaign. [Running a Mythic Game](/pathfinderRPG/prd/mythicAdventures/mythicGame.html) includes more information for GMs to consider when designing the moment of ascension. The following ideas represent some of the most common means of ascension.
...
**Legendary Item (Ex)** : You gain a [legendary item](/pathfinderRPG/prd/mythicAdventures/mythicItems/legendaryItems.html#_legendary-items). This item grants a number of abilities equal to your tier (maximum 3). At 3rd tier, you can select this ability again, increasing the maximum to six abilities and causing the item to become a lesser artifact. At 6th tier, you can select this ability again, increasing the maximum to 10 abilities; the item then becomes a greater artifact.
...
**Farwalker (Sp)** : The boundaries of the Material Plane mean little to you. You can _ [plane shift](/pathfinderRPG/prd/spells/planeShift.html#_plane-shift) _once per day, using double your tier as your caster level. You can take this ability twice. When you take it a second time, you can use this ability three times per day.
...
**Mythic Sight (Sp)** : When you take this ability, you gain blindsense out to a range of 30 feet. You can take this ability twice. The second time you take it, you can see illusions and magical deceptions for what they truly are, as if using _ [true seeing](/pathfinderRPG/prd/spells/trueSeeing.html#_true-seeing)_. This ability doesn't apply to illusions and magical effects that were cast by other mythic creatures or that are affecting other mythic creatures. If this ability is dispelled, you can resume it as a free action.

**Tongues (Sp)** : You can understand and speak any language, as the _ [tongues](/pathfinderRPG/prd/spells/tongues.html#_tongues)_ spell. If this ability is dispelled, you can resume it as a free action.
