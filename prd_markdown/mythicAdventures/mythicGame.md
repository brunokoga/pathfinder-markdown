...
To adjust a foe's CR, add half its tier or rank (minimum 1) to its CR. So a 2nd-rank minotaur is effectively a CR 6 monster, while a 6th-tier champion pit fiend would be CR 23. For [mythic monsters](/pathfinderRPG/prd/mythicAdventures/mythicMonsters.html), this calculation has already been made.
...
**Calm Down** : The character ends or prevents a combat against a mythic foe with a single skill check, most likely [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) or [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff).
...
**Outrageous Lie** : Using [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff), the character convinces a creature of a nearly impossible lie (–20 modifier to the check).
...
**Tumbler** : In 1 round, the character uses [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) to move through the threatened areas of at least five foes without provoking any attacks of opportunity.
...
Noncombat encounters help players develop a connection between their PCs and the villain in a way that doesn't risk the villain's life (or the PCs'). Early on, she can appear as a harmless or even helpful NPC. Or, if the PCs have already fought the villain, she can leave notes or use magic to taunt them. Various mythic powers, the [Disguise](/pathfinderRPG/prd/skills/disguise.html#_disguise) skill, or even simple magic like _ [disguise self](/pathfinderRPG/prd/spells/disguiseSelf.html#_disguise-self)_, _ [glibness](/pathfinderRPG/prd/spells/glibness.html#_glibness)_, or _ [nondetection](/pathfinderRPG/prd/spells/nondetection.html#_nondetection)_ can be used to help a villain blend in and rub elbows with the heroes all while seeming innocuous. Later, once the villain is revealed, she can work behind the scenes, using minions and other allies to accomplish her ends, all the while making it plain to the PCs that she's continuing to thwart them.
...
Should the villain be killed, don't be afraid to have her revisit your campaign for a little posthumous mockery and mayhem. There are many ways to reintroduce a dead villain—sometimes it's as simple as having a minion cast _ [raise dead](/pathfinderRPG/prd/spells/raiseDead.html#_raise-dead) _or_ [resurrection](/pathfinderRPG/prd/spells/resurrection.html#_resurrection)_, but there are other, more sophisticated options. You can introduce a new recurring villain who tracks down one of the PCs' dead foes and brings him to some semblance of life in the form of an undead minion or possessed item, or who uses _ [speak with dead](/pathfinderRPG/prd/spells/speakWithDead.html#_speak-with-dead)_ to learn the deceased foe's secrets.
