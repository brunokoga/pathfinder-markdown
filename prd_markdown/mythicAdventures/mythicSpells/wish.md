...
**Source** [_wish_](/pathfinderRPG/prd/spells/wish.html#_wish)
...
You can also produce any one of the following effects that modify or replace effects listed in the non-mythic _ [wish](/pathfinderRPG/prd/spells/wish.html#_wish)_ spell description:
...
- If you use _mythic wish_ to revive the dead, you can expend a second use of mythic power to negate the target's permanent negative level from the _ [resurrection](/pathfinderRPG/prd/spells/resurrection.html#_resurrection)_.
