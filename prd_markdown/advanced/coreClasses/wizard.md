...
_Air Supremacy (Su)_: You gain a +2 enhancement bonus on [Fly](../../skills/fly.html#_fly) skill checks. This bonus increases by +1 for every five wizard levels you possess. In addition, you can cast _ [feather fall](../../spells/featherFall.html#_feather-fall)_ on yourself at will. At 5th level, you can cast _ [levitate](../../spells/levitate.html#_levitate)_ on yourself at will. At 10th level, you can cast _ [fly](../../spells/fly.html) _on yourself at will. At 20th level, whenever you make a [Fly](../../skills/fly.html#_fly) skill check, assume the roll resulted in a natural 20.
...
_Cyclone (Su)_: At 8th level, you can create a vortex of turbulent wind around yourself as a standard action. This vortex has a radius of up to 10 feet and a maximum height of 10 feet per wizard level you possess. Any ranged attack passing through this vortex automatically misses. Any flying creature moving through the vortex must make a [Fly](../../skills/fly.html#_fly) skill check or immediately fall from the sky, taking falling damage (the creature cannot make a [Fly](../../skills/fly.html#_fly) check to reduce or negate this damage). Creatures on the ground cannot pass through the vortex without first making a Strength check. The DC of this check is equal to 10 + your caster level. The vortex is faintly visible and can be spotted with a DC 15 [Perception](../../skills/perception.html#_perception) skill check. You can use this ability for a number of rounds per day equal to your wizard level. These rounds do not need to be consecutive.
...
**Versatile Evocation (Su)** : When you cast an evocation spell that does acid, cold, electricity, or fire damage, you may change the damage dealt to one of the other four energy types. This changes the descriptor of the spell to match the new energy type. Any non-damaging effects remain unchanged unless the new energy type invalidates them (an _ [ice storm](../../spells/iceStorm.html#_ice-storm)_ that deals fire damage might still provide a penalty on [Perception](../../skills/perception.html#_perception) checks due to smoke, but it would not create difficult terrain). Such effects are subject to GM discretion. You can use this ability a number of times per day equal to 3 + your Intelligence modifier.
...
**Shadow Step (Sp)** : At 8th level, you can use this ability to walk through the Shadow Plane and reappear as a standard action. You can travel up to 30 feet per wizard level per day in this fashion, either in a single round or broken up across multiple shadow steps. This movement must be used in 5-foot increments and does not provoke an attack of opportunity. Travel through the Shadow Plane is imprecise; when you arrive, you re-enter 1 square off target, as per the rules for thrown [splash weapons](../../combat.html#_throw-splash-weapon). If this would place you in an occupied square, you instead arrive in the nearest safe location. When you arrive, you are cloaked in shadow and gain concealment as the _ [blur](../../spells/blur.html#_blur)_ spell for 1 round. You may bring other willing creatures with you, but you must expend an equal amount of distance for each additional creature brought with you. They likewise re-enter off target (roll location for each creature) and are cloaked in shadow for 1 round.
...
**Shift (Su)** : At 1st level, you can teleport to a nearby space as a swift action as if using _ [dimension door](../../spells/dimensionDoor.html#_dimension-door)_. This movement does not provoke an attack of opportunity. You must be able to see the space that you are moving into. You cannot take other creatures with you when you use this ability (except for familiars). You can move 5 feet for every two wizard levels you possess (minimum 5 feet). You can use this ability a number of times per day equal to 3 + your Intelligence modifier.
