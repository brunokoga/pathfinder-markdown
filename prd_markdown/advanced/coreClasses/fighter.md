...
**Hawkeye (Ex)** : At 2nd level, an archer gains a +1 bonus on [Perception](../../skills/perception.html#_perception) checks, and the range increment for any bow he uses increases by 5 feet. These bonuses increase by +1 and 5 additional feet for every 4 levels beyond 2nd. This ability replaces bravery.
...
**Ranged Defense (Ex)** : At 19th level, an archer gains DR 5/— against ranged attacks. In addition, as an immediate action, he can catch an arrow fired at him and shoot it any target he chooses, as if he had the [Snatch Arrows](../../feats.html#_snatch-arrows) feat. This ability replaces armor mastery.
...
**Quick Sniper (Ex)** : At 9th level, a crossbowman gains a bonus equal to 1/2 his fighter level on [Stealth](../../skills/stealth.html#_stealth) checks when sniping. When he is hit with a ranged attack, he can shoot his crossbow at his attacker as an immediate action if it is loaded. This ability replaces weapon training 2.
...
**Pinpoint Targeting** : At 15th level, a crossbowman gains [Pinpoint Targeting](../../feats.html#_pinpoint-targeting) as a bonus feat. This ability replaces armor training 4.
...
**Deceptive Strike (Ex)** : At 2nd level, a free hand fighter gains a +1 bonus to CMB and CMD on disarm checks and on [Bluff](../../skills/bluff.html#_bluff) checks to feint or create a diversion to hide. This bonus increases by +1 for every four levels after 2nd. This ability replaces bravery.
...
**[Fleet](../../feats.html#_fleet) Footed (Ex)** : At 15th level, the mobile fighter's speed increases by 10 feet. He can take 10 on [Acrobatics](../../skills/acrobatics.html#_acrobatics) checks even while distracted or threatened, and can take 20 on an [Acrobatics](../../skills/acrobatics.html#_acrobatics) check once per day for every five fighter levels he possesses. This ability replaces armor training 4.

**Whirlwind Blitz (Ex)** : At 20th level, a mobile fighter can make a full-attack action as a standard action. He may also use the [Whirlwind Attack](../../feats.html#_whirlwind-attack) feat as a standard action. This ability replaces weapon mastery.
...
At 13th level, he can instead provide cover (+4 cover bonus to AC, +2 bonus on Reflex saves) and evasion (as a rogue) to one adjacent ally until the beginning of his next turn. This cover does not allow [Stealth](../../skills/stealth.html#_stealth) checks.
...
**Armored Charger (Ex)** : At 3rd level, a roughrider no longer suffers armor check penalties on [Ride](../../skills/ride.html#_ride) skill checks. His mount's speed is not reduced when carrying a medium load or wearing medium barding. This ability replaces armor training 1.
...
**Leap from the Saddle (Ex)** : At 7th level, after a roughrider's mount takes a single move, he may attempt a fast dismount (DC 20 [Ride](../../skills/ride.html#_ride) check). If he succeeds, he can take a full attack action. This ability replaces armor training 2.

**Relentless Steed (Ex)** : At 11th level, a roughrider's mount does not reduce its speed when wearing heavy barding or carrying a heavy load. The roughrider may also reroll a [Ride](../../skills/ride.html#_ride) skill check or a saving throw made by the mount once per day, but must use the second roll even if it is worse. This ability may be used one additional time per day for every four levels beyond 11th. This ability replaces armor training 3.

**[Ride](../../skills/ride.html#_ride) Them Down (Ex)** : At 15th level, can spur his mount on while readying an attack. If a roughrider's mount takes a single move, the roughrider can make a full attack, taking his attacks at any point during his mount's movement. If he has the [Trample](../../feats.html#_trample) feat, he may substitute an overrun combat maneuver for each of his attacks. This movement provokes attacks of opportunity against the roughrider but not his mount. This ability replaces armor training 4.
...
**Greater [Power Attack](../../feats.html#_power-attack) (Ex)** : At 15th level, when using [Power Attack](../../feats.html#_power-attack) with a two-handed melee weapon, the bonus damage from [Power Attack](../../feats.html#_power-attack) is doubled (+100%) instead of increased by half (+50%). This ability replaces armor training 4.
...
**Weapon Guard (Ex)** : At 2nd level, a weapon master gains a +1 bonus to CMD against disarm and sunder attempts while wielding his chosen weapon. This bonus also applies on saves against any effect that targets his chosen weapon (for example, _ [grease](../../spells/grease.html#_grease), [heat metal](../../spells/heatMetal.html#_heat-metal), [shatter](../../spells/shatter.html#_shatter), [warp wood](../../spells/warpWood.html#_warp-wood)_). The bonus increases by +1 for every four levels beyond 2nd. This ability replaces bravery.
