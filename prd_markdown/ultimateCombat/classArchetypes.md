...
**[Alchemist](classArchetypes/alchemist.html)** : This section presents new discoveries, as well as the beastmorph and ragechemist archetypes.

**[Barbarian](classArchetypes/barbarian.html)** : This section includes new rage powers, as well as the armored hulk, scarred rager, sea reaver, titan mauler, true primitive, urban barbarian, and wild rager.

**[Bard](classArchetypes/bard.html)** : This section includes the archaeologist, daredevil, and dervish dancer.

**[Cavalier](classArchetypes/cavalier.html)** : This section includes new cavalier orders, plus the beast rider, emissary, gendarme, honor guard, luring cavalier, musketeer, standard bearer, and strategist.

**[Cleric](classArchetypes/cleric.html)** : This section includes the crusader, divine strategist, evangelist, and merciful healer.

**[Druid](classArchetypes/druid.html)** : This section includes the ape shaman, bat shaman, and boar shaman, as well as the world walker.

**[Fighter](classArchetypes/fighter.html)** : This section includes expanded weapon groups, plus the armor master, brawler, cad, dragoon, gladiator, tactician, thunderstriker, tower shield specialist, unarmed fighter, and unbreakable.

**[Gunslinger](classArchetypes/gunslinger.html)** : This section includes the gun tank, musket master, mysterious stranger, and pistolero.

**[Inquisitor](classArchetypes/inquisitor.html)** : This section includes new inquisitions, plus the iconoclast, spellbreaker, and witch hunter.

**[Magus](classArchetypes/magus.html)** : This section includes new magus arcana, plus the kensai, myrmidarch, skirnir, and soul forger.

**[Monk](classArchetypes/monk.html)** : This section includes the flowing monk, maneuver master, martial artist, master of many styles, sensei, sohei, and tetori.

**[Paladin](classArchetypes/paladin.html)** : This section includes the divine hunter, empyreal knight, holy gun, holy tactician, knight of the sepulcher, and sacred shield.

**[Ranger](classArchetypes/ranger.html)** : This section includes the battle scout, deep walker, falconer, trophy hunter, warden, and wild stalker.

**[Rogue](classArchetypes/rogue.html)** : This section includes new rogue talents, plus the bandit, chameleon, charlatan, driver, knife master, pirate, roof runner, sanctified rogue, and survivalist.

**[Wizard](classArchetypes/wizard.html)** : This section includes the arcane bomber, siege mage, and spellslinger.
