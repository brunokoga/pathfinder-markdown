...
**Adaptability** : Half-elves receive [Skill Focus](/pathfinderRPG/prd/feats.html#_skill-focus) as a bonus feat at 1st level.

**Elf Blood** : Half-elves count as both elves and humans for any effect related to race.

**Elven Immunities** : Half-elves are immune to magic sleep effects and gain a +2 racial saving throw bonus against enchantment spells and effects.

**Keen Senses** : Half-elves receive a +2 racial bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks.
...
**Ancestral Arms** : Some half-elves receive training in an unusual weapon. Half-elves with this racial trait receive [Exotic Weapon Proficiency](/pathfinderRPG/prd/feats.html#_exotic-weapon-proficiency) or [Martial Weapon Proficiency](/pathfinderRPG/prd/feats.html#_martial-weapon-proficiency) with one weapon as a bonus feat at 1st level. This racial trait replaces the adaptability racial trait.
...
**Monk** : Add +1/2 on [Escape Artist](/pathfinderRPG/prd/skills/escapeArtist.html#_escape-artist) checks and on [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) checks to cross narrow surfaces.
...
**Rogue** : Add a +1/2 bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) checks to feint and [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) checks to gather information.
...
> _Amulet_: 2nd— [_stone fist_](/pathfinderRPG/prd/advanced/spells/stoneFist.html#_stone-fist); 4th—_ [bear's endurance](/pathfinderRPG/prd/spells/bearSEndurance.html#_bear-s-endurance)_; 6th—_ [burst of speed](/pathfinderRPG/prd/ultimateCombat/spells/burstOfSpeed.html#_burst-of-speed)_; 8th—_ [mnemonic enhancer](/pathfinderRPG/prd/spells/mnemonicEnhancer.html#_mnemonic-enhancer);_ 10th—_ [stoneskin](/pathfinderRPG/prd/spells/stoneskin.html#_stoneskin);_ 12th—_ [monstrous physique IV](/pathfinderRPG/prd/ultimateMagic/spells/monstrousPhysique.html#_monstrous-physique-iv)_; 14th—_ [firebrand](/pathfinderRPG/prd/advanced/spells/firebrand.html#_firebrand)_; 16th—_ [iron body](/pathfinderRPG/prd/spells/ironBody.html#_iron-body)_; 18th—_ [overwhelming presence](/pathfinderRPG/prd/ultimateMagic/spells/overwhelmingPresence.html#_overwhelming-presence)_.
> 
> _Ring_: 2nd—_ [shield](/pathfinderRPG/prd/spells/shield.html#_shield);_ 4th—_ [ablative barrier](/pathfinderRPG/prd/ultimateCombat/spells/ablativeBarrier.html#_ablative-barrier)_; 6th—_ [protection from energy](/pathfinderRPG/prd/spells/protectionFromEnergy.html#_protection-from-energy);_ 8th—_ [nondetection](/pathfinderRPG/prd/spells/nondetection.html#_nondetection);_ 10th—_ [life bubble](/pathfinderRPG/prd/advanced/spells/lifeBubble.html#_life-bubble-)_; 12th—_ [resinous skin](/pathfinderRPG/prd/ultimateCombat/spells/resinousSkin.html#_resinous-skin)_; 14th—_ [antimagic field](/pathfinderRPG/prd/spells/antimagicField.html#_antimagic-field);_ 16th—_ [deflection](/pathfinderRPG/prd/advanced/spells/deflection.html#_deflection-)_; 18th—_ [spell immunity](/pathfinderRPG/prd/spells/spellImmunity.html#_spell-immunity)_.
> 
> _Staff_: 2nd—_ [shillelagh](/pathfinderRPG/prd/spells/shillelagh.html#_shillelagh);_ 4th—_ [warp wood](/pathfinderRPG/prd/spells/warpWood.html#_warp-wood);_ 6th—_ [plant growth](/pathfinderRPG/prd/spells/plantGrowth.html#_plant-growth);_ 8th—_ [arboreal hammer](/pathfinderRPG/prd/ultimateMagic/spells/arborealHammer.html#_arboreal-hammer)_; 10th—_ [passwall](/pathfinderRPG/prd/spells/passwall.html#_passwall)_; 12th—_ [move earth](/pathfinderRPG/prd/spells/moveEarth.html#_move-earth);_ 14th— [_changestaff_](/pathfinderRPG/prd/spells/changestaff.html#_changestaff); 16th—_ [control plants](/pathfinderRPG/prd/spells/controlPlants.html#_control-plants);_ 18th—_ [wooden phalanx](/pathfinderRPG/prd/ultimateMagic/spells/woodenPhalanx.html#_wooden-phalanx)_.
> 
> _Wand_: 2nd—_ [magic missile](/pathfinderRPG/prd/spells/magicMissile.html#_magic-missile);_ 4th—_ [knock](/pathfinderRPG/prd/spells/knock.html#_knock);_ 6th—_ [fireball](/pathfinderRPG/prd/spells/fireball.html#_fireball);_ 8th—_ [restoration](/pathfinderRPG/prd/spells/restoration.html#_restoration);_ 10th—maximized _ [scorching ray](/pathfinderRPG/prd/spells/scorchingRay.html#_scorching-ray)_; 12th—_ [bull's strength](/pathfinderRPG/prd/spells/bullSStrength.html#_bull-s-strength)_ (mass); 14th—_ [greater restoration](/pathfinderRPG/prd/spells/restoration.html#_restoration-greater);_ 16th—empowered and maximized _ [fireball](/pathfinderRPG/prd/spells/fireball.html#_fireball)_; 18th—empowered and maximized _ [fire shield](/pathfinderRPG/prd/spells/fireShield.html#_fire-shield)_.
> 
> _Weapon_: 2nd—_ [warding weapon](/pathfinderRPG/prd/ultimateCombat/spells/wardingWeapon.html#_warding-weapon)_; 4th—_ [versatile weapon](/pathfinderRPG/prd/advanced/spells/versatileWeapon.html#_versatile-weapon)_; 6th—_ [greater magic weapon](/pathfinderRPG/prd/spells/magicWeapon.html#_magic-weapon-greater)_; 8th—_ [telekinetic charge](/pathfinderRPG/prd/ultimateCombat/spells/telekineticCharge.html#_telekinetic-charge-)_; 10th—_ [energy siege shot](/pathfinderRPG/prd/ultimateCombat/spells/energySiegeShot.html#_energy-siege-shot)_; 12th—_ [blade barrier](/pathfinderRPG/prd/spells/bladeBarrier.html#_blade-barrier)_; 14th—_ [arcane cannon](/pathfinderRPG/prd/ultimateCombat/spells/arcaneCannon.html#_arcane-cannon)_; 16th—_ [earthquake](/pathfinderRPG/prd/spells/earthquake.html#_earthquake)_; 18th—_ [ride the lightning](/pathfinderRPG/prd/ultimateMagic/spells/rideTheLightning.html#_ride-the-lightning)_.
...
_1-point evolutions_: basic magic, magic attacks, skilled (while the eidolon can select this evolution, it can only do so with the following skills: [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics), [Climb](/pathfinderRPG/prd/skills/climb.html#_climb), [Escape Artist](/pathfinderRPG/prd/skills/escapeArtist.html#_escape-artist), [Fly](/pathfinderRPG/prd/skills/fly.html#_fly), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate), [Perception](/pathfinderRPG/prd/skills/perception.html#_perception), [Survival](/pathfinderRPG/prd/skills/survival.html#_survival), and [Swim](/pathfinderRPG/prd/skills/swim.html#_swim)), unnatural aura; _2-point evolutions_: energy attacks, immunity, weapon training, channel resistance, head, minor magic, undead appearance; _3-point evolutions_: damage reduction, frightful presence, major magic; _4-point evolutions_: breath weapon, spell resistance, dimension door, incorporeal form, lifesense, no breath, ultimate magic.

This ability alters the normal summoner's eidolon class feature, but is otherwise identical to that class feature.

**_Summon Nature's Ally I_ (Sp)** : Starting at 1st level, a wild caller can cast _summon nature's ally_ a number of times per day equal to 3 + his Charisma modifier. At 3rd level and every 2 levels thereafter, the power of this ability increases by one spell level, allowing him to summon more powerful creatures (to a maximum of _ [summon nature's ally IX](/pathfinderRPG/prd/spells/summonNatureSAlly.html#_summon-nature-s-ally-ix)_ at 17th level). Furthermore, at 19th level, the wild caller cannot use _ [gate](/pathfinderRPG/prd/spells/gate.html#_gate)_ as a spell-like ability, but can use either _ [summon elder worm](/pathfinderRPG/prd/ultimateMagic/spells/summonElderWorm.html#_summon-elder-worm)_ or _ [summon froghemoth](/pathfinderRPG/prd/ultimateMagic/spells/summonFroghemoth.html#_summon-froghemoth)_ instead. This ability otherwise functions like the standard summoner's _ [summon monster I](/pathfinderRPG/prd/spells/summonMonster.html#_summon-monster-i)_ ability and replaces that ability.
...
**Benefit** : You are not considered elven or human for the purpose of harmful spells or effects based on your type, like a _ [bane](/pathfinderRPG/prd/magicItems/weapons.html#_weapons-bane)_ weapon or a ranger's favored enemy class feature.
...
**Benefit** : You gain a +2 bonus on all saving throws against scrying or divination effects. Additionally, you gain a +2 bonus on all [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) checks, and elves, half-elves, and humans take a –4 penalty on all efforts to track you through the [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) skill.
...
**Benefit** : As a move action, you can grant all friendly creatures within 30 feet who can see or hear you a +2 bonus on [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) or [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks (choose which skill to affect each time you use this ability) for a number of rounds equal to your Charisma modifier (minimum 1 round).
...
**Requirements** [Craft Wondrous Item](/pathfinderRPG/prd/feats.html#_craft-wondrous-item), _paragon surge_, creator must be a half-elf_;_ **Cost** 5,000 gp
...
Occasionally, half-elves find it socially advantageous to blend in fully with either elves or humans. As a standard action, the wearer of this brooch can transform his features to appear either entirely elven or entirely human. The magic of this brooch actually changes the wearer's features physically, granting him a +20 circumstance bonus on [Disguise](/pathfinderRPG/prd/skills/disguise.html#_disguise) checks to appear as a member of the selected race. The transformation does not otherwise alter the wearer's features, and those who know him recognize him without a [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) check. This change remains until the brooch is used again or removed. This change does not radiate magic and cannot be seen with _ [detect magic](/pathfinderRPG/prd/spells/detectMagic.html#_detect-magic)_, although _ [true seeing](/pathfinderRPG/prd/spells/trueSeeing.html#_true-seeing)_ does reveal the alteration. This item only functions for half-elves, but there are versions that exist for half-orcs as well.

Construction

**Requirements** [Craft Wondrous Item](/pathfinderRPG/prd/feats.html#_craft-wondrous-item), _ [alter self](/pathfinderRPG/prd/spells/alterSelf.html#_alter-self)_, creator must be a half-elf; **Cost** 1,000 gp
...
Half-elves are often called upon to mediate disputes when elves and humans come into conflict. This is due in part to their blood, but also to their natural skills as facilitators and diplomats. The _cloak of the diplomat_ greatly aids them in this task. The cloak grants a +5 competence bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) checks. In addition, once per day, before making a [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) or [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) check, the wearer can decide to call upon the powers of the cloak to roll twice and take the better result. Finally, the wearer of this cloak can adjust a creature's attitude up to three steps when using [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy), instead of the normal limit of two steps. However, the cloak's power does have one drawback. Should the wearer ever fail a [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) check to adjust a creature's attitude by 5 or more, the creature's attitude is reduced by two steps instead of one.

Construction

**Requirements** [Craft Wondrous Item](/pathfinderRPG/prd/feats.html#_craft-wondrous-item), _ [charm person](/pathfinderRPG/prd/spells/charmPerson.html#_charm-person)_, creator must have 5 ranks in [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) and [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive); **Cost** 10,000 gp
...
A favored tool of diplomats and those tasked with protecting the lives of regents and other important people, this small luminescent white pearl purifies putridity and poison in two ways. First, up to 10 cubic feet of food or drink that it touches per day is affected as if a _ [purify food and drink](/pathfinderRPG/prd/spells/purifyFoodAndDrink.html#_purify-food-and-drink)_ spell had been cast upon the food or drink. Second, once per day, if placed in the mouth of a creature (as a standard action that provokes attacks of opportunity), the pearl acts as a _ [neutralize poison](/pathfinderRPG/prd/spells/neutralizePoison.html#_neutralize-poison)_ spell cast on that creature (caster level 10th).

Construction

**Requirements** [Craft Wondrous Item](/pathfinderRPG/prd/feats.html#_craft-wondrous-item), _ [neutralize poison](/pathfinderRPG/prd/spells/neutralizePoison.html#_neutralize-poison), purify food and [water](/pathfinderRPG/prd/monsters/creatureTypes.html#_water-subtype)_; **Cost** 8,000 gp
...
A favorite ring of urban half-elves, humans, and halflings, this small and plain silver band is set with a single radiant-cut sapphire and decorated with a mazelike pattern engraved into the ring's metal. Often worn on the little finger, the ring grants its wearer a +4 competence bonus on [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local) checks. Also, once per day on command, the wearer can use the ring to cast either _ [locate creature](/pathfinderRPG/prd/spells/locateCreature.html#_locate-creature)_ or _ [locate object](/pathfinderRPG/prd/spells/locateObject.html#_locate-object)_ (the wearer's choice). Furthermore, on command and at will, the wearer can instantly know the direction from her to the nearest tavern, pub, or similar watering hole as long as that establishment is in a settlement whose population is equivalent to that of a village or greater and which is within 20 miles of the wearer.

CONSTRUCTION

**Requirements** [Forge Ring](/pathfinderRPG/prd/feats.html#_forge-ring), know direction, locate creature, locate object, creator must have at least 4 ranks in both [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) and [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (local); **Cost** 5,500 gp
...
**Components** V, S, M (a few drops of river [water](/pathfinderRPG/prd/monsters/creatureTypes.html#_water-subtype))

**Range** close (25 ft. + 5 ft./2 levels)

**Target** one living creatureâ© **Duration** 1 minute/level

**Saving Throw** Will negates; **Spell Resistance** yes

This spell acts as the _deeper slumber_ spell, but only affects one creature of 10 Hit Dice or fewer. In addition, a creature affected by this spell awakens with no knowledge of the events that led to the spell's casting. The target loses all memory from the 5 minutes prior to falling asleep. No effect short of a _ [miracle](/pathfinderRPG/prd/spells/miracle.html#_miracle)_ or _ [wish](/pathfinderRPG/prd/spells/wish.html#_wish)_ can restore memories lost by this spell.
...
You become one with the city around you, allowing you to move more easily through its crowds and buildings. For the duration of this spell, your base land speed increases by 10 feet. In addition, it does not cost you 2 squares of movement to enter a square with crowds, though the crowd still provides cover to you. This ability does not allow you to enter the space of enemy creatures without making the appropriate [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) check. In addition, you receive a +4 circumstance bonus on [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) checks made to move across uneven urban surfaces, such as roofs and broken pavement, and on [Climb](/pathfinderRPG/prd/skills/climb.html#_climb) checks made to scale walls and other artificial surfaces. Whenever you make an [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) check to make a long jump between two buildings or artificial structures, you are always treated as if you had a running start, regardless of the actual distance traveled.
