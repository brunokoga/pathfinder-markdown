...
**Seasinger** : The beautiful voices of the merfolk are legendary. A seasinger gains a +2 racial bonus on [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) (sing) checks and a +1 racial bonus to the save DC of language-dependent spells. This racial trait replaces low-light vision.
...
**Deep Sentinel (Ex)** : A wave warden adds half his level (minimum +1) on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks made to notice creatures underwater. This ability replaces track.

**Aquatic Prowess Feat (Ex)** : At 2nd level and every four levels thereafter, a wave warden selects a bonus feat that improves his prowess in aquatic environments. He can choose these feats even if he does not meet the prerequisites. Initially, he may choose from the following feats: [Dodge](/pathfinderRPG/prd/feats.html#_dodge), Mobility, [Net Adept](/pathfinderRPG/prd/ultimateCombat/ultimateCombatFeats.html#_net-adept), [Net and Trident](/pathfinderRPG/prd/ultimateCombat/ultimateCombatFeats.html#_net-and-trident), [Net Maneuvering](/pathfinderRPG/prd/ultimateCombat/ultimateCombatFeats.html#_net-maneuvering), Precise Shot, [Rapid Reload](/pathfinderRPG/prd/ultimateCombat/ultimateCombatFeats.html#_rapid-reload), Sea Hunter, and [Two-Weapon Fighting](/pathfinderRPG/prd/feats.html#_two-weapon-fighting). At 6th level, he adds Improved [Two-Weapon Fighting](/pathfinderRPG/prd/feats.html#_two-weapon-fighting), [Net Trickery](/pathfinderRPG/prd/ultimateCombat/ultimateCombatFeats.html#_net-trickery), and Spring Attack to the list. At 10th level, he adds Greater [Two-Weapon Fighting](/pathfinderRPG/prd/feats.html#_two-weapon-fighting) and Improved Precise Shot to the list. This ability otherwise functions like and replaces the standard ranger's combat style bonus feats, including the limitations on armor worn.
...
**Prerequisites** : [Combat Expertise](/pathfinderRPG/prd/feats.html#_combat-expertise), merfolk.

**Benefit** : When you make a successful melee attack against a swimming target, as a free action you can attempt to knock the target off balance. Treat this as a trip combat maneuver. If you succeed, the target is considered off balance until it recovers its balance, usually by making a [Swim](/pathfinderRPG/prd/skills/swim.html#_swim) check on its turn. This feat has no effect on creatures with a swim speed, those using magic such as _ [freedom of movement](/pathfinderRPG/prd/spells/freedomOfMovement.html#_freedom-of-movement)_, and creatures that can't be tripped.
...
**Requirements** [Craft Wondrous Item](/pathfinderRPG/prd/feats.html#_craft-wondrous-item), _fins to feet_; **Cost** 3,000 gp
