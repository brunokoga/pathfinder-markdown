...
**Small** : Goblins are Small creatures and gain a +1 size bonus to their AC, a +1 size bonus on attack rolls, a –1 penalty to their CMB and CMD, and a +4 size bonus on [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) checks.

**Fast** : Goblins are fast for their size, and have a base speed of 30 feet.

**Darkvision** : Goblins can see in the dark up to 60 feet.

**Skilled** : +4 racial bonus on [Ride](/pathfinderRPG/prd/skills/ride.html#_ride) and [Stealth](/pathfinderRPG/prd/skills/stealth.html#_stealth) checks.
...
**Cave Crawler** : Some goblins are born and raised in caves and rarely see the light of day. Goblins with this trait gain a climb speed of 10 feet and the +8 racial bonus on [Climb](/pathfinderRPG/prd/skills/climb.html#_climb) checks associated with having a climb speed. Goblins with this racial trait have a base speed of 20 feet and lose the fast movement racial trait.

**City Scavenger** : Goblins who live within the boundaries of human cities survive by scavenging for refuse and hunting stray animals. Goblins with this trait gain a +2 racial bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) and [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks, and can use [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) to forage for food while in a city. This racial trait replaces skilled.

**Eat Anything** : Raised with little or no proper food, many goblins have learned to survive by eating whatever they happen across and can digest nearly anything without getting sick. Goblins with this trait gain a +4 on [Survival](/pathfinderRPG/prd/skills/survival.html#_survival) checks to forage for food and a +4 racial bonus on saves versus effects that cause the nauseated or sickened conditions. This racial trait replaces skilled.
...
**Over-Sized Ears** : While goblins' ears are never dainty, these goblins have freakishly large ears capable of picking up even the smallest sounds. Goblins with this racial trait gain a +4 bonus on [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) checks. This racial trait replaces skilled.

**Tree Runner** : In trackless rain forests and marshes, it can be difficult to find dry ground to build on. Goblin tribes living in such areas have learned to live in the treetops. These goblins gain a +4 racial bonus on [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) and [Climb](/pathfinderRPG/prd/skills/climb.html#_climb) checks. This racial trait replaces skilled.
...
**Barbarian** : Add +1/2 on critical hit confirmation rolls for attacks made with unarmed strikes or natural weapons (maximum bonus of +4). This bonus does not stack with [Critical Focus](/pathfinderRPG/prd/feats.html#_critical-focus).
...
**[Improvised Weapon Mastery](/pathfinderRPG/prd/feats.html#_improvised-weapon-mastery) (Ex)** : At 5th level, a feral gnasher gains [Improvised Weapon Mastery](/pathfinderRPG/prd/feats.html#_improvised-weapon-mastery) as a bonus feat. This replaces improved uncanny dodge.
...
**Fire Body (Ex)** : At 8th level, a fire bomber adds _ [elemental body I](/pathfinderRPG/prd/spells/elementalBody.html#_elemental-body-i)_ to his extract list as a 3rd-level extract. _Elemental body_ extracts prepared using fire body are limited to fire elementals only. This ability replaces poison resistance +6.

**Improved Fire Body (Ex)** : At 10th level, fire bombers add _ [elemental body II](/pathfinderRPG/prd/spells/elementalBody.html#_elemental-body-ii)_ to their spell list as a 4th-level extract. _Elemental body_ extracts prepared using improved fire body are limited to fire elementals only. This ability replaces poison immunity.

**Greater Fire Body (Ex)** : At 14th level, fire bombers add _ [elemental body IV](/pathfinderRPG/prd/spells/elementalBody.html#_elemental-body-iv)_ to their spell list as a 5th-level extract._ Elemental body_ extracts prepared using greater fire body are limited to fire elementals only. This ability replaces persistent mutagen.
...
**Prerequisites** : [Disable Device](/pathfinderRPG/prd/skills/disableDevice.html#_disable-device) 1 rank, goblin.
...
**Benefit** : You gain a +2 bonus on saves against spells with the fire descriptor. Additionally, your scars mark you as a talented fire tamer, granting you a +2 circumstance bonus on [Diplomacy](/pathfinderRPG/prd/skills/diplomacy.html#_diplomacy) and [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks when dealing with other goblins.
...
**Prerequisites** : [Dodge](/pathfinderRPG/prd/feats.html#_dodge), Mobility, [Underfoot](/pathfinderRPG/prd/advanced/advancedFeats.html#_underfoot) , goblin, Small size or smaller.

**Benefit** : When you successfully make an [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) check to avoid provoking an attack of opportunity from a larger opponent when you move through its threatened area or its space, you can make that opponent lose its balance until the end of its next turn as a free action. While that creature's balance is lost, if it attempts to move, it must make a successful DC 15 [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) check or fall prone, wasting the move action. You can only affect one creature with this effect each round.
...
**Requirements** [Craft Wondrous Item](/pathfinderRPG/prd/feats.html#_craft-wondrous-item), _ [alter self](/pathfinderRPG/prd/spells/alterSelf.html#_alter-self)_, _ [resistance](/pathfinderRPG/prd/spells/resistance.html#_resistance)_; **Cost** 1,250 gp
