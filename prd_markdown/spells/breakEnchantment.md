...
If the spell is one that cannot be dispelled by _ [dispel magic](dispelMagic.html#_dispel-magic)_ or _stone to flesh_, _break enchantment _works only if that spell is 5th level or lower.
