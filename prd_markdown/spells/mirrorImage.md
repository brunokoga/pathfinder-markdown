...
An attacker must be able to see the figments to be fooled. If you are [invisible](../glossary.html#_invisible) or the attacker is blind, the spell has no effect (although the normal miss chances still apply).
