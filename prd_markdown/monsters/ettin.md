...
**Init** +3; **Senses** low-light vision; [Perception](../skills/perception.html#_perception) +12
...
**Feats** [Cleave](../feats.html#_cleave), [Improved Initiative](../feats.html#_improved-initiative), [Improved Overrun](../feats.html#_improved-overrun), [Iron Will](../feats.html#_iron-will), [Power Attack](../feats.html#_power-attack)

**Skills** [Handle Animal](../skills/handleAnimal.html#_handle-animal) +8, [Perception](../skills/perception.html#_perception) +12; **Racial Modifiers** +4 on [Perception](../skills/perception.html#_perception)
...
**Superior [Two-Weapon Fighting](../feats.html#_two-weapon-fighting) (Ex)** An ettin fights with a flail or javelin in each hand. Because each of its two heads controls an arm, the ettin does not take a penalty on attack or damage rolls for attacking with two weapons.
