...
**Greater Lore (Ex)** : At 6th level, a loremaster gains the ability to understand magic items. Whenever a loremaster examines a magic item to determine its properties, he gains a +10 circumstance bonus on his [Spellcraft](../skills/spellcraft.html#_spellcraft) skill check.

**True Lore (Ex)** : At 10th level, a loremaster's knowledge becomes vast indeed. Once per day a loremaster can use his knowledge to gain the effect of a _ [legend lore](../spells/legendLore.html#_legend-lore) _spell or an _ [analyze dweomer](../spells/analyzeDweomer.html#_analyze-dweomer) _spell. If used to create a _ [legend lore](../spells/legendLore.html#_legend-lore)_ effect, this ability has a casting time of 1 minute, regardless of how much information is already known about the subject in question.
